...
class FfiConverterConflict {
  ...
  static LiftRetVal<Conflict> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
...
class FfiConverterOutput {
  ...
  static LiftRetVal<Output> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final redeemScript_lifted = FfiConverterOptionalScript.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    ...
    final tapInternalKey = tapInternalKey_lifted.value;
    new_offset += tapInternalKey_lifted.bytesRead;
    final tapTree_lifted = FfiConverterOptionalTapTree.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final tapTree = tapTree_lifted.value;
    new_offset += tapTree_lifted.bytesRead;
    final tapKeyOrigins_lifted = FfiConverterMapStringToTapKeyOrigin.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final tapKeyOrigins = tapKeyOrigins_lifted.value;
  ...
  static RustBuffer lower(Output value) {
    final total_length =
        FfiConverterOptionalScript.allocationSize(value.redeemScript) +
        FfiConverterOptionalScript.allocationSize(value.witnessScript) +
        FfiConverterMapStringToKeySource.allocationSize(value.bip32Derivation) +
        FfiConverterOptionalString.allocationSize(value.tapInternalKey) +
        FfiConverterOptionalTapTree.allocationSize(value.tapTree) +
        FfiConverterMapStringToTapKeyOrigin.allocationSize(
          value.tapKeyOrigins,
        ) +
        FfiConverterMapProprietaryKeyToUint8List.allocationSize(
  ...
  static int write(Output value, Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    new_offset += FfiConverterOptionalScript.write(
      value.redeemScript,
      Uint8List.view(buf.buffer, new_offset),
    ...
    new_offset += FfiConverterOptionalTapTree.write(
      value.tapTree,
      Uint8List.view(buf.buffer, new_offset),
    );
    new_offset += FfiConverterMapStringToTapKeyOrigin.write(
  ...
  static int allocationSize(Output value) {
    return FfiConverterOptionalScript.allocationSize(value.redeemScript) +
        FfiConverterOptionalScript.allocationSize(value.witnessScript) +
        FfiConverterMapStringToKeySource.allocationSize(value.bip32Derivation) +
        FfiConverterOptionalString.allocationSize(value.tapInternalKey) +
        FfiConverterOptionalTapTree.allocationSize(value.tapTree) +
...
class FfiConverterPeer {
  ...
  static LiftRetVal<Peer> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final address_lifted = IpAddress.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final address = address_lifted.value;
    new_offset += address_lifted.bytesRead;
    final port_lifted = FfiConverterOptionalUInt16.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final port = port_lifted.value;
    new_offset += port_lifted.bytesRead;
    final v2Transport_lifted = FfiConverterBool.read(
      Uint8List.view(buf.buffer, new_offset),
    );
  ...
  static RustBuffer lower(Peer value) {
    final total_length =
        IpAddress.allocationSize(value.address) +
...
class FfiConverterProprietaryKey {
  ...
  static LiftRetVal<ProprietaryKey> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final prefix_lifted = FfiConverterUint8List.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final prefix = prefix_lifted.value;
    new_offset += prefix_lifted.bytesRead;
    final subtype_lifted = FfiConverterUInt8.read(
      Uint8List.view(buf.buffer, new_offset),
    );
  ...
  static RustBuffer lower(ProprietaryKey value) {
    final total_length =
        FfiConverterUint8List.allocationSize(value.prefix) +
...
class FfiConverterScriptAmount {
  ...
  static RustBuffer lower(ScriptAmount value) {
    final total_length =
        Script.allocationSize(value.script) +
...
class FfiConverterSocks5Proxy {
  ...
  static LiftRetVal<Socks5Proxy> read(Uint8List buf) {
    ...
    final address = address_lifted.value;
    new_offset += address_lifted.bytesRead;
    final port_lifted = FfiConverterUInt16.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final port = port_lifted.value;
    new_offset += port_lifted.bytesRead;
...
class FfiConverterTapKeyOrigin {
  ...
  static LiftRetVal<TapKeyOrigin> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final tapLeafHashes_lifted = FfiConverterSequenceString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final tapLeafHashes = tapLeafHashes_lifted.value;
    new_offset += tapLeafHashes_lifted.bytesRead;
    final keySource_lifted = FfiConverterKeySource.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterTapScriptSigKey {
  ...
  static LiftRetVal<TapScriptSigKey> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final xonlyPubkey_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final xonlyPubkey = xonlyPubkey_lifted.value;
    new_offset += xonlyPubkey_lifted.bytesRead;
    final tapLeafHash_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterTx {
  ...
  static LiftRetVal<Tx> read(Uint8List buf) {
    ...
    final version = version_lifted.value;
    new_offset += version_lifted.bytesRead;
    final locktime_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    ...
    final weight_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final weight = weight_lifted.value;
    new_offset += weight_lifted.bytesRead;
    final fee_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final fee = fee_lifted.value;
    new_offset += fee_lifted.bytesRead;
    final status_lifted = FfiConverterTxStatus.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterTxDetails {
  ...
  static LiftRetVal<TxDetails> read(Uint8List buf) {
    ...
    final received = received_lifted.value;
    new_offset += received_lifted.bytesRead;
    final fee_lifted = FfiConverterOptionalAmount.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final fee = fee_lifted.value;
    new_offset += fee_lifted.bytesRead;
    ...
    final balanceDelta_lifted = FfiConverterInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterTxGraphChangeSet {
  ...
  static LiftRetVal<TxGraphChangeSet> read(Uint8List buf) {
    ...
    final anchors_lifted = FfiConverterSequenceAnchor.read(
      Uint8List.view(buf.buffer, new_offset),
    );
  ...
  static RustBuffer lower(TxGraphChangeSet value) {
    final total_length =
        FfiConverterSequenceTransaction.allocationSize(value.txs) +
...
class FfiConverterTxIn {
  ...
  static LiftRetVal<TxIn> read(Uint8List buf) {
    ...
    final scriptSig_lifted = Script.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterTxOut {
  ...
  static LiftRetVal<TxOut> read(Uint8List buf) {
    ...
    final scriptPubkey_lifted = Script.read(
      Uint8List.view(buf.buffer, new_offset),
    );
  ...
  static RustBuffer lower(TxOut value) {
    final total_length =
        Amount.allocationSize(value.value) +
...
class FfiConverterTxStatus {
  ...
  static LiftRetVal<TxStatus> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final confirmed_lifted = FfiConverterBool.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final confirmed = confirmed_lifted.value;
    new_offset += confirmed_lifted.bytesRead;
    final blockHeight_lifted = FfiConverterOptionalUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    ...
    final blockTime_lifted = FfiConverterOptionalUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterUnconfirmedTx {
  ...
  static LiftRetVal<UnconfirmedTx> read(Uint8List buf) {
    ...
    final tx = tx_lifted.value;
    new_offset += tx_lifted.bytesRead;
    final lastSeen_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final lastSeen = lastSeen_lifted.value;
    new_offset += lastSeen_lifted.bytesRead;
...
class FfiConverterWitnessProgram {
  ...
  static LiftRetVal<WitnessProgram> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final version_lifted = FfiConverterUInt8.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final version = version_lifted.value;
    new_offset += version_lifted.bytesRead;
    final program_lifted = FfiConverterUint8List.read(
      Uint8List.view(buf.buffer, new_offset),
    );
...
class FfiConverterAddForeignUtxoException {
  ...
  static LiftRetVal<AddForeignUtxoException> read(Uint8List buf) {
    ...
    switch (index) {
      case 1:
        return InvalidTxidAddForeignUtxoException.read(subview);
      case 2:
        return InvalidOutpointAddForeignUtxoException.read(subview);
      case 3:
        return MissingUtxoAddForeignUtxoException.read(subview);
      case 4:
        return InputConversionExceptionAddForeignUtxoException.read(subview);
      default:
...
class P2pkhAddressData extends AddressData {
  ...
  static LiftRetVal<P2pkhAddressData> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final pubkeyHash_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final pubkeyHash = pubkeyHash_lifted.value;
    new_offset += pubkeyHash_lifted.bytesRead;
    return LiftRetVal(P2pkhAddressData._(pubkeyHash), new_offset);
  }
...
class SegwitAddressData extends AddressData {
  ...
  SegwitAddressData(WitnessProgram this.witnessProgram);
  SegwitAddressData._(WitnessProgram this.witnessProgram);
  static LiftRetVal<SegwitAddressData> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final witnessProgram_lifted = FfiConverterWitnessProgram.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final witnessProgram = witnessProgram_lifted.value;
    new_offset += witnessProgram_lifted.bytesRead;
    return LiftRetVal(SegwitAddressData._(witnessProgram), new_offset);
  }
...
class WitnessVersionAddressParseException extends AddressParseException {
  final String errorMessage;
  WitnessVersionAddressParseException(String this.errorMessage);
  WitnessVersionAddressParseException._(String this.errorMessage);
...
class WitnessProgramAddressParseException extends AddressParseException {
  final String errorMessage;
  WitnessProgramAddressParseException(String this.errorMessage);
  WitnessProgramAddressParseException._(String this.errorMessage);
...
class Secp256k1Bip32Exception extends Bip32Exception {
  final String errorMessage;
  Secp256k1Bip32Exception(String this.errorMessage);
  Secp256k1Bip32Exception._(String this.errorMessage);
  static LiftRetVal<Secp256k1Bip32Exception> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(Secp256k1Bip32Exception._(errorMessage), new_offset);
  }
...
class InvalidChildNumberBip32Exception extends Bip32Exception {
  ...
  InvalidChildNumberBip32Exception(int this.childNumber);
  InvalidChildNumberBip32Exception._(int this.childNumber);
  static LiftRetVal<InvalidChildNumberBip32Exception> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final childNumber_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final childNumber = childNumber_lifted.value;
    new_offset += childNumber_lifted.bytesRead;
    return LiftRetVal(
      InvalidChildNumberBip32Exception._(childNumber),
      new_offset,
    );
  }
...
class UnknownVersionBip32Exception extends Bip32Exception {
  ...
  UnknownVersionBip32Exception(String this.version);
  UnknownVersionBip32Exception._(String this.version);
  static LiftRetVal<UnknownVersionBip32Exception> read(Uint8List buf) {
    ...
    final version = version_lifted.value;
    new_offset += version_lifted.bytesRead;
    return LiftRetVal(UnknownVersionBip32Exception._(version), new_offset);
  }
...
class WrongExtendedKeyLengthBip32Exception extends Bip32Exception {
  final int length;
  WrongExtendedKeyLengthBip32Exception(int this.length);
  WrongExtendedKeyLengthBip32Exception._(int this.length);
  static LiftRetVal<WrongExtendedKeyLengthBip32Exception> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final length_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final length = length_lifted.value;
    new_offset += length_lifted.bytesRead;
    return LiftRetVal(
      WrongExtendedKeyLengthBip32Exception._(length),
      new_offset,
    );
  }
...
class Base58Bip32Exception extends Bip32Exception {
  final String errorMessage;
  Base58Bip32Exception(String this.errorMessage);
  Base58Bip32Exception._(String this.errorMessage);
  static LiftRetVal<Base58Bip32Exception> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(Base58Bip32Exception._(errorMessage), new_offset);
  }
...
class HexBip32Exception extends Bip32Exception {
  final String errorMessage;
  HexBip32Exception(String this.errorMessage);
  HexBip32Exception._(String this.errorMessage);
  static LiftRetVal<HexBip32Exception> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(HexBip32Exception._(errorMessage), new_offset);
  }
...
class InvalidPublicKeyHexLengthBip32Exception extends Bip32Exception {
  final int length;
  InvalidPublicKeyHexLengthBip32Exception(int this.length);
  InvalidPublicKeyHexLengthBip32Exception._(int this.length);
...
class UnknownExceptionBip32Exception extends Bip32Exception {
  final String errorMessage;
  UnknownExceptionBip32Exception(String this.errorMessage);
  UnknownExceptionBip32Exception._(String this.errorMessage);
...
class BadWordCountBip39Exception extends Bip39Exception {
  final int wordCount;
  BadWordCountBip39Exception(int this.wordCount);
  BadWordCountBip39Exception._(int this.wordCount);
  static LiftRetVal<BadWordCountBip39Exception> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final wordCount_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final wordCount = wordCount_lifted.value;
    new_offset += wordCount_lifted.bytesRead;
    return LiftRetVal(BadWordCountBip39Exception._(wordCount), new_offset);
  }
...
class UnknownWordBip39Exception extends Bip39Exception {
  final int index;
  UnknownWordBip39Exception(int this.index);
  ...
  static LiftRetVal<UnknownWordBip39Exception> read(Uint8List buf) {
    ...
    final index = index_lifted.value;
    new_offset += index_lifted.bytesRead;
    return LiftRetVal(UnknownWordBip39Exception._(index), new_offset);
  }
...
class BadEntropyBitCountBip39Exception extends Bip39Exception {
  final int bitCount;
  BadEntropyBitCountBip39Exception(int this.bitCount);
  BadEntropyBitCountBip39Exception._(int this.bitCount);
  static LiftRetVal<BadEntropyBitCountBip39Exception> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final bitCount_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final bitCount = bitCount_lifted.value;
    new_offset += bitCount_lifted.bytesRead;
    return LiftRetVal(BadEntropyBitCountBip39Exception._(bitCount), new_offset);
  }
...
class AmbiguousLanguagesBip39Exception extends Bip39Exception {
  ...
  AmbiguousLanguagesBip39Exception(String this.languages);
  AmbiguousLanguagesBip39Exception._(String this.languages);
  static LiftRetVal<AmbiguousLanguagesBip39Exception> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final languages_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final languages = languages_lifted.value;
    new_offset += languages_lifted.bytesRead;
    return LiftRetVal(
      AmbiguousLanguagesBip39Exception._(languages),
      new_offset,
    );
  }
...
class MissingTxOutCalculateFeeException extends CalculateFeeException {
  ...
  MissingTxOutCalculateFeeException(List<OutPoint> this.outPoints);
  MissingTxOutCalculateFeeException._(List<OutPoint> this.outPoints);
  static LiftRetVal<MissingTxOutCalculateFeeException> read(Uint8List buf) {
    ...
    return LiftRetVal(
      MissingTxOutCalculateFeeException._(outPoints),
      new_offset,
    );
  }
...
class NegativeFeeCalculateFeeException extends CalculateFeeException {
  final String amount;
  NegativeFeeCalculateFeeException(String this.amount);
  NegativeFeeCalculateFeeException._(String this.amount);
  static LiftRetVal<NegativeFeeCalculateFeeException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final amount_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final amount = amount_lifted.value;
    new_offset += amount_lifted.bytesRead;
    return LiftRetVal(NegativeFeeCalculateFeeException._(amount), new_offset);
  }
...
class IncludeCannotConnectException extends CannotConnectException {
  final int height;
  IncludeCannotConnectException(int this.height);
  IncludeCannotConnectException._(int this.height);
  static LiftRetVal<IncludeCannotConnectException> read(Uint8List buf) {
    ...
    final height = height_lifted.value;
    new_offset += height_lifted.bytesRead;
    return LiftRetVal(IncludeCannotConnectException._(height), new_offset);
  }
...
class ConfirmedChainPosition extends ChainPosition {
  ...
  static LiftRetVal<ConfirmedChainPosition> read(Uint8List buf) {
    ...
    final confirmationBlockTime = confirmationBlockTime_lifted.value;
    new_offset += confirmationBlockTime_lifted.bytesRead;
    final transitively_lifted = FfiConverterOptionalTxid.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final transitively = transitively_lifted.value;
    new_offset += transitively_lifted.bytesRead;
    return LiftRetVal(
      ConfirmedChainPosition._(confirmationBlockTime, transitively),
      new_offset,
    );
  }
...
class FfiConverterChangeSpendPolicy {
  static LiftRetVal<ChangeSpendPolicy> read(Uint8List buf) {
    ...
    switch (index) {
      case 1:
        return LiftRetVal(ChangeSpendPolicy.changeAllowed, 4);
      case 2:
        return LiftRetVal(ChangeSpendPolicy.onlyChange, 4);
      case 3:
        return LiftRetVal(ChangeSpendPolicy.changeForbidden, 4);
      default:
        throw UniffiInternalError(
          UniffiInternalError.unexpectedEnumCase,
          "Unable to determine enum variant",
...
class DescriptorCreateTxException extends CreateTxException {
  final String errorMessage;
  DescriptorCreateTxException(String this.errorMessage);
  DescriptorCreateTxException._(String this.errorMessage);
  static LiftRetVal<DescriptorCreateTxException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(DescriptorCreateTxException._(errorMessage), new_offset);
  }
...
class PolicyCreateTxException extends CreateTxException {
  final String errorMessage;
  PolicyCreateTxException(String this.errorMessage);
  PolicyCreateTxException._(String this.errorMessage);
  static LiftRetVal<PolicyCreateTxException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(PolicyCreateTxException._(errorMessage), new_offset);
  }
...
class SpendingPolicyRequiredCreateTxException extends CreateTxException {
  final String kind;
  SpendingPolicyRequiredCreateTxException(String this.kind);
  SpendingPolicyRequiredCreateTxException._(String this.kind);
  static LiftRetVal<SpendingPolicyRequiredCreateTxException> read(
    ...
    return LiftRetVal(
      SpendingPolicyRequiredCreateTxException._(kind),
      new_offset,
    );
  }
...
class RbfSequenceCsvCreateTxException extends CreateTxException {
  ...
  RbfSequenceCsvCreateTxException._(String this.sequence, String this.csv);
  static LiftRetVal<RbfSequenceCsvCreateTxException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final sequence_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final sequence = sequence_lifted.value;
    new_offset += sequence_lifted.bytesRead;
    final csv_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final csv = csv_lifted.value;
    new_offset += csv_lifted.bytesRead;
    return LiftRetVal(
      RbfSequenceCsvCreateTxException._(sequence, csv),
      new_offset,
    );
  }
...
class FeeTooLowCreateTxException extends CreateTxException {
  final String required_;
  FeeTooLowCreateTxException(String this.required_);
  FeeTooLowCreateTxException._(String this.required_);
  static LiftRetVal<FeeTooLowCreateTxException> read(Uint8List buf) {
    ...
    final required_ = required__lifted.value;
    new_offset += required__lifted.bytesRead;
    return LiftRetVal(FeeTooLowCreateTxException._(required_), new_offset);
  }
...
class FeeRateTooLowCreateTxException extends CreateTxException {
  final String required_;
  FeeRateTooLowCreateTxException(String this.required_);
  FeeRateTooLowCreateTxException._(String this.required_);
  static LiftRetVal<FeeRateTooLowCreateTxException> read(Uint8List buf) {
    ...
    final required_ = required__lifted.value;
    new_offset += required__lifted.bytesRead;
    return LiftRetVal(FeeRateTooLowCreateTxException._(required_), new_offset);
  }
...
class OutputBelowDustLimitCreateTxException extends CreateTxException {
  final int index;
  OutputBelowDustLimitCreateTxException(int this.index);
  ...
  static LiftRetVal<OutputBelowDustLimitCreateTxException> read(Uint8List buf) {
    ...
    new_offset += index_lifted.bytesRead;
    return LiftRetVal(
      OutputBelowDustLimitCreateTxException._(index),
      new_offset,
    );
  }
...
class CoinSelectionCreateTxException extends CreateTxException {
  final String errorMessage;
  CoinSelectionCreateTxException(String this.errorMessage);
  CoinSelectionCreateTxException._(String this.errorMessage);
...
class InsufficientFundsCreateTxException extends CreateTxException {
  ...
  InsufficientFundsCreateTxException._(int this.needed, int this.available);
  static LiftRetVal<InsufficientFundsCreateTxException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final needed_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final needed = needed_lifted.value;
    new_offset += needed_lifted.bytesRead;
    final available_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final available = available_lifted.value;
    new_offset += available_lifted.bytesRead;
    return LiftRetVal(
      InsufficientFundsCreateTxException._(needed, available),
      new_offset,
    );
  }
...
class PsbtCreateTxException extends CreateTxException {
  final String errorMessage;
  PsbtCreateTxException(String this.errorMessage);
  PsbtCreateTxException._(String this.errorMessage);
  static LiftRetVal<PsbtCreateTxException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(PsbtCreateTxException._(errorMessage), new_offset);
  }
...
class MissingKeyOriginCreateTxException extends CreateTxException {
  final String key;
  MissingKeyOriginCreateTxException(String this.key);
  MissingKeyOriginCreateTxException._(String this.key);
  static LiftRetVal<MissingKeyOriginCreateTxException> read(Uint8List buf) {
    ...
    final key = key_lifted.value;
    new_offset += key_lifted.bytesRead;
    return LiftRetVal(MissingKeyOriginCreateTxException._(key), new_offset);
  }
...
class UnknownUtxoCreateTxException extends CreateTxException {
  final String outpoint;
  UnknownUtxoCreateTxException(String this.outpoint);
  ...
  static LiftRetVal<UnknownUtxoCreateTxException> read(Uint8List buf) {
    ...
    final outpoint = outpoint_lifted.value;
    new_offset += outpoint_lifted.bytesRead;
    return LiftRetVal(UnknownUtxoCreateTxException._(outpoint), new_offset);
  }
...
class MissingNonWitnessUtxoCreateTxException extends CreateTxException {
  final String outpoint;
  MissingNonWitnessUtxoCreateTxException(String this.outpoint);
  MissingNonWitnessUtxoCreateTxException._(String this.outpoint);
  static LiftRetVal<MissingNonWitnessUtxoCreateTxException> read(
    ...
    new_offset += outpoint_lifted.bytesRead;
    return LiftRetVal(
      MissingNonWitnessUtxoCreateTxException._(outpoint),
      new_offset,
    );
  }
...
class MiniscriptPsbtCreateTxException extends CreateTxException {
  final String errorMessage;
  MiniscriptPsbtCreateTxException(String this.errorMessage);
  MiniscriptPsbtCreateTxException._(String this.errorMessage);
  static LiftRetVal<MiniscriptPsbtCreateTxException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      MiniscriptPsbtCreateTxException._(errorMessage),
      new_offset,
    );
  }
...
class FfiConverterCreateWithPersistException {
  static CreateWithPersistException lift(RustBuffer buffer) {
    return FfiConverterCreateWithPersistException.read(
      buffer.asUint8List(),
    ).value;
  }
...
class PersistCreateWithPersistException extends CreateWithPersistException {
  final String errorMessage;
  PersistCreateWithPersistException(String this.errorMessage);
  PersistCreateWithPersistException._(String this.errorMessage);
  static LiftRetVal<PersistCreateWithPersistException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      PersistCreateWithPersistException._(errorMessage),
      new_offset,
    );
  }
...
class DescriptorCreateWithPersistException extends CreateWithPersistException {
  final String errorMessage;
  DescriptorCreateWithPersistException(String this.errorMessage);
  DescriptorCreateWithPersistException._(String this.errorMessage);
  static LiftRetVal<DescriptorCreateWithPersistException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      DescriptorCreateWithPersistException._(errorMessage),
      new_offset,
    );
  }
...
class KeyDescriptorException extends DescriptorException {
  final String errorMessage;
  KeyDescriptorException(String this.errorMessage);
  KeyDescriptorException._(String this.errorMessage);
  static LiftRetVal<KeyDescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(KeyDescriptorException._(errorMessage), new_offset);
  }
...
class PolicyDescriptorException extends DescriptorException {
  final String errorMessage;
  PolicyDescriptorException(String this.errorMessage);
  PolicyDescriptorException._(String this.errorMessage);
  static LiftRetVal<PolicyDescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(PolicyDescriptorException._(errorMessage), new_offset);
  }
...
class InvalidDescriptorCharacterDescriptorException
  ...
  final String char;
  InvalidDescriptorCharacterDescriptorException(String this.char);
  InvalidDescriptorCharacterDescriptorException._(String this.char);
  static LiftRetVal<InvalidDescriptorCharacterDescriptorException> read(
    Uint8List buf,
  ) {
    int new_offset = buf.offsetInBytes;
    final char_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final char = char_lifted.value;
    new_offset += char_lifted.bytesRead;
    return LiftRetVal(
      InvalidDescriptorCharacterDescriptorException._(char),
      new_offset,
    );
  }
...
class Bip32DescriptorException extends DescriptorException {
  final String errorMessage;
  Bip32DescriptorException(String this.errorMessage);
  Bip32DescriptorException._(String this.errorMessage);
  static LiftRetVal<Bip32DescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(Bip32DescriptorException._(errorMessage), new_offset);
  }
...
class Base58DescriptorException extends DescriptorException {
  final String errorMessage;
  Base58DescriptorException(String this.errorMessage);
  Base58DescriptorException._(String this.errorMessage);
  static LiftRetVal<Base58DescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(Base58DescriptorException._(errorMessage), new_offset);
  }
...
class PkDescriptorException extends DescriptorException {
  final String errorMessage;
  PkDescriptorException(String this.errorMessage);
  PkDescriptorException._(String this.errorMessage);
  static LiftRetVal<PkDescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(PkDescriptorException._(errorMessage), new_offset);
  }
...
class MiniscriptDescriptorException extends DescriptorException {
  final String errorMessage;
  MiniscriptDescriptorException(String this.errorMessage);
  MiniscriptDescriptorException._(String this.errorMessage);
...
class HexDescriptorException extends DescriptorException {
  final String errorMessage;
  HexDescriptorException(String this.errorMessage);
  HexDescriptorException._(String this.errorMessage);
  static LiftRetVal<HexDescriptorException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(HexDescriptorException._(errorMessage), new_offset);
  }
...
class ParseDescriptorKeyException extends DescriptorKeyException {
  final String errorMessage;
  ParseDescriptorKeyException(String this.errorMessage);
  ParseDescriptorKeyException._(String this.errorMessage);
  static LiftRetVal<ParseDescriptorKeyException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ParseDescriptorKeyException._(errorMessage), new_offset);
  }
...
class Bip32DescriptorKeyException extends DescriptorKeyException {
  final String errorMessage;
  Bip32DescriptorKeyException(String this.errorMessage);
  Bip32DescriptorKeyException._(String this.errorMessage);
  static LiftRetVal<Bip32DescriptorKeyException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(Bip32DescriptorKeyException._(errorMessage), new_offset);
  }
...
class FfiConverterDescriptorType {
  static LiftRetVal<DescriptorType> read(Uint8List buf) {
    ...
    switch (index) {
      case 1:
        return LiftRetVal(DescriptorType.bare, 4);
      case 2:
        return LiftRetVal(DescriptorType.sh, 4);
      case 3:
        return LiftRetVal(DescriptorType.pkh, 4);
      case 4:
        return LiftRetVal(DescriptorType.wpkh, 4);
      case 5:
        return LiftRetVal(DescriptorType.wsh, 4);
      case 6:
        return LiftRetVal(DescriptorType.shWsh, 4);
      case 7:
        return LiftRetVal(DescriptorType.shWpkh, 4);
      case 8:
        return LiftRetVal(DescriptorType.shSortedMulti, 4);
      case 9:
        return LiftRetVal(DescriptorType.wshSortedMulti, 4);
      case 10:
        return LiftRetVal(DescriptorType.shWshSortedMulti, 4);
      case 11:
        return LiftRetVal(DescriptorType.tr, 4);
      default:
        throw UniffiInternalError(
          UniffiInternalError.unexpectedEnumCase,
          "Unable to determine enum variant",
...
class IoExceptionElectrumException extends ElectrumException {
  final String errorMessage;
  IoExceptionElectrumException(String this.errorMessage);
  IoExceptionElectrumException._(String this.errorMessage);
  static LiftRetVal<IoExceptionElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(IoExceptionElectrumException._(errorMessage), new_offset);
  }
...
class JsonElectrumException extends ElectrumException {
  final String errorMessage;
  JsonElectrumException(String this.errorMessage);
  JsonElectrumException._(String this.errorMessage);
  static LiftRetVal<JsonElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(JsonElectrumException._(errorMessage), new_offset);
  }
...
class HexElectrumException extends ElectrumException {
  final String errorMessage;
  HexElectrumException(String this.errorMessage);
  HexElectrumException._(String this.errorMessage);
  static LiftRetVal<HexElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(HexElectrumException._(errorMessage), new_offset);
  }
...
class ProtocolElectrumException extends ElectrumException {
  final String errorMessage;
  ProtocolElectrumException(String this.errorMessage);
  ProtocolElectrumException._(String this.errorMessage);
  static LiftRetVal<ProtocolElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ProtocolElectrumException._(errorMessage), new_offset);
  }
...
class BitcoinElectrumException extends ElectrumException {
  final String errorMessage;
  BitcoinElectrumException(String this.errorMessage);
  BitcoinElectrumException._(String this.errorMessage);
  static LiftRetVal<BitcoinElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(BitcoinElectrumException._(errorMessage), new_offset);
  }
...
class InvalidResponseElectrumException extends ElectrumException {
  final String errorMessage;
  InvalidResponseElectrumException(String this.errorMessage);
  InvalidResponseElectrumException._(String this.errorMessage);
...
class MessageElectrumException extends ElectrumException {
  final String errorMessage;
  MessageElectrumException(String this.errorMessage);
  MessageElectrumException._(String this.errorMessage);
  static LiftRetVal<MessageElectrumException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(MessageElectrumException._(errorMessage), new_offset);
  }
...
class InvalidDnsNameExceptionElectrumException extends ElectrumException {
  final String domain;
  InvalidDnsNameExceptionElectrumException(String this.domain);
  InvalidDnsNameExceptionElectrumException._(String this.domain);
  static LiftRetVal<InvalidDnsNameExceptionElectrumException> read(
    Uint8List buf,
  ) {
    int new_offset = buf.offsetInBytes;
    final domain_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final domain = domain_lifted.value;
    new_offset += domain_lifted.bytesRead;
    return LiftRetVal(
      InvalidDnsNameExceptionElectrumException._(domain),
      new_offset,
    );
  }
...
class SharedIoExceptionElectrumException extends ElectrumException {
  final String errorMessage;
  SharedIoExceptionElectrumException(String this.errorMessage);
  SharedIoExceptionElectrumException._(String this.errorMessage);
...
class CouldNotCreateConnectionElectrumException extends ElectrumException {
  final String errorMessage;
  CouldNotCreateConnectionElectrumException(String this.errorMessage);
  CouldNotCreateConnectionElectrumException._(String this.errorMessage);
...
class MinreqEsploraException extends EsploraException {
  final String errorMessage;
  MinreqEsploraException(String this.errorMessage);
  MinreqEsploraException._(String this.errorMessage);
  static LiftRetVal<MinreqEsploraException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(MinreqEsploraException._(errorMessage), new_offset);
  }
...
class HttpResponseEsploraException extends EsploraException {
  ...
  HttpResponseEsploraException._(int this.status, String this.errorMessage);
  static LiftRetVal<HttpResponseEsploraException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      HttpResponseEsploraException._(status, errorMessage),
      new_offset,
    );
  }
...
class ParsingEsploraException extends EsploraException {
  final String errorMessage;
  ParsingEsploraException(String this.errorMessage);
  ParsingEsploraException._(String this.errorMessage);
  static LiftRetVal<ParsingEsploraException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ParsingEsploraException._(errorMessage), new_offset);
  }
...
class StatusCodeEsploraException extends EsploraException {
  final String errorMessage;
  StatusCodeEsploraException(String this.errorMessage);
  StatusCodeEsploraException._(String this.errorMessage);
  static LiftRetVal<StatusCodeEsploraException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(StatusCodeEsploraException._(errorMessage), new_offset);
  }
...
class BitcoinEncodingEsploraException extends EsploraException {
  final String errorMessage;
  BitcoinEncodingEsploraException(String this.errorMessage);
  BitcoinEncodingEsploraException._(String this.errorMessage);
...
class HexToArrayEsploraException extends EsploraException {
  final String errorMessage;
  HexToArrayEsploraException(String this.errorMessage);
  HexToArrayEsploraException._(String this.errorMessage);
  static LiftRetVal<HexToArrayEsploraException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(HexToArrayEsploraException._(errorMessage), new_offset);
  }
...
class HexToBytesEsploraException extends EsploraException {
  final String errorMessage;
  HexToBytesEsploraException(String this.errorMessage);
  HexToBytesEsploraException._(String this.errorMessage);
  static LiftRetVal<HexToBytesEsploraException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(HexToBytesEsploraException._(errorMessage), new_offset);
  }
...
class HeaderHeightNotFoundEsploraException extends EsploraException {
  final int height;
  HeaderHeightNotFoundEsploraException(int this.height);
  HeaderHeightNotFoundEsploraException._(int this.height);
  static LiftRetVal<HeaderHeightNotFoundEsploraException> read(Uint8List buf) {
    ...
    new_offset += height_lifted.bytesRead;
    return LiftRetVal(
      HeaderHeightNotFoundEsploraException._(height),
      new_offset,
    );
  }
...
class InvalidHttpHeaderNameEsploraException extends EsploraException {
  final String name;
  InvalidHttpHeaderNameEsploraException(String this.name);
  InvalidHttpHeaderNameEsploraException._(String this.name);
  static LiftRetVal<InvalidHttpHeaderNameEsploraException> read(Uint8List buf) {
    ...
    return LiftRetVal(
      InvalidHttpHeaderNameEsploraException._(name),
      new_offset,
    );
  }
...
class InvalidHttpHeaderValueEsploraException extends EsploraException {
  final String value;
  InvalidHttpHeaderValueEsploraException(String this.value);
  InvalidHttpHeaderValueEsploraException._(String this.value);
  static LiftRetVal<InvalidHttpHeaderValueEsploraException> read(
    ...
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(
      InvalidHttpHeaderValueEsploraException._(value),
      new_offset,
    );
  }
...
class AbsurdFeeRateExtractTxException extends ExtractTxException {
  final int feeRate;
  AbsurdFeeRateExtractTxException(int this.feeRate);
  AbsurdFeeRateExtractTxException._(int this.feeRate);
  static LiftRetVal<AbsurdFeeRateExtractTxException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final feeRate_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final feeRate = feeRate_lifted.value;
    new_offset += feeRate_lifted.bytesRead;
    return LiftRetVal(AbsurdFeeRateExtractTxException._(feeRate), new_offset);
  }
...
class WitnessProgramFromScriptException extends FromScriptException {
  final String errorMessage;
  WitnessProgramFromScriptException(String this.errorMessage);
  WitnessProgramFromScriptException._(String this.errorMessage);
  static LiftRetVal<WitnessProgramFromScriptException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      WitnessProgramFromScriptException._(errorMessage),
      new_offset,
    );
  }
...
class WitnessVersionFromScriptException extends FromScriptException {
  final String errorMessage;
  WitnessVersionFromScriptException(String this.errorMessage);
  WitnessVersionFromScriptException._(String this.errorMessage);
...
class InvalidHashHashParseException extends HashParseException {
  final int len;
  InvalidHashHashParseException(int this.len);
  InvalidHashHashParseException._(int this.len);
  static LiftRetVal<InvalidHashHashParseException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final len_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final len = len_lifted.value;
    new_offset += len_lifted.bytesRead;
    return LiftRetVal(InvalidHashHashParseException._(len), new_offset);
  }
...
class InvalidHexStringHashParseException extends HashParseException {
  final String hex;
  InvalidHexStringHashParseException(String this.hex);
  InvalidHexStringHashParseException._(String this.hex);
  static LiftRetVal<InvalidHexStringHashParseException> read(Uint8List buf) {
    ...
    return LiftRetVal(InvalidHexStringHashParseException._(hex), new_offset);
  }
...
class BlockReceivedInfo extends Info {
  final String v0;
  BlockReceivedInfo(String this.v0);
  BlockReceivedInfo._(String this.v0);
  static LiftRetVal<BlockReceivedInfo> read(Uint8List buf) {
    ...
    return LiftRetVal(BlockReceivedInfo._(v0), new_offset);
  }
...
class FfiConverterKeychainKind {
  static LiftRetVal<KeychainKind> read(Uint8List buf) {
    ...
    switch (index) {
      case 1:
        return LiftRetVal(KeychainKind.external_, 4);
      case 2:
        return LiftRetVal(KeychainKind.internal, 4);
      default:
        throw UniffiInternalError(
          UniffiInternalError.unexpectedEnumCase,
          "Unable to determine enum variant",
...
class FfiConverterLoadWithPersistException {
  static LoadWithPersistException lift(RustBuffer buffer) {
    return FfiConverterLoadWithPersistException.read(
      buffer.asUint8List(),
    ).value;
  }
...
class PersistLoadWithPersistException extends LoadWithPersistException {
  final String errorMessage;
  PersistLoadWithPersistException(String this.errorMessage);
  PersistLoadWithPersistException._(String this.errorMessage);
...
class InvalidChangeSetLoadWithPersistException
  ...
  final String errorMessage;
  InvalidChangeSetLoadWithPersistException(String this.errorMessage);
  InvalidChangeSetLoadWithPersistException._(String this.errorMessage);
  static LiftRetVal<InvalidChangeSetLoadWithPersistException> read(
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      InvalidChangeSetLoadWithPersistException._(errorMessage),
      new_offset,
    );
  }
...
class BlocksLockTime extends LockTime {
  final int height;
  BlocksLockTime(int this.height);
  BlocksLockTime._(int this.height);
  static LiftRetVal<BlocksLockTime> read(Uint8List buf) {
    ...
    final height = height_lifted.value;
    new_offset += height_lifted.bytesRead;
    return LiftRetVal(BlocksLockTime._(height), new_offset);
  }
...
class SecondsLockTime extends LockTime {
  ...
  SecondsLockTime(int this.consensusTime);
  SecondsLockTime._(int this.consensusTime);
  static LiftRetVal<SecondsLockTime> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final consensusTime_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final consensusTime = consensusTime_lifted.value;
    new_offset += consensusTime_lifted.bytesRead;
    return LiftRetVal(SecondsLockTime._(consensusTime), new_offset);
  }
...
class AddrExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  AddrExceptionMiniscriptException(String this.errorMessage);
  AddrExceptionMiniscriptException._(String this.errorMessage);
...
class AddrP2shExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  AddrP2shExceptionMiniscriptException(String this.errorMessage);
  AddrP2shExceptionMiniscriptException._(String this.errorMessage);
  static LiftRetVal<AddrP2shExceptionMiniscriptException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      AddrP2shExceptionMiniscriptException._(errorMessage),
      new_offset,
    );
  }
...
class AnalysisExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  AnalysisExceptionMiniscriptException(String this.errorMessage);
  AnalysisExceptionMiniscriptException._(String this.errorMessage);
  static LiftRetVal<AnalysisExceptionMiniscriptException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      AnalysisExceptionMiniscriptException._(errorMessage),
      new_offset,
    );
  }
...
class BadDescriptorMiniscriptException extends MiniscriptException {
  final String errorMessage;
  BadDescriptorMiniscriptException(String this.errorMessage);
  BadDescriptorMiniscriptException._(String this.errorMessage);
...
class CmsTooManyKeysMiniscriptException extends MiniscriptException {
  final int keys;
  CmsTooManyKeysMiniscriptException(int this.keys);
  CmsTooManyKeysMiniscriptException._(int this.keys);
  static LiftRetVal<CmsTooManyKeysMiniscriptException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final keys_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final keys = keys_lifted.value;
    new_offset += keys_lifted.bytesRead;
    return LiftRetVal(CmsTooManyKeysMiniscriptException._(keys), new_offset);
  }
...
class ContextExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  ContextExceptionMiniscriptException(String this.errorMessage);
  ContextExceptionMiniscriptException._(String this.errorMessage);
  static LiftRetVal<ContextExceptionMiniscriptException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      ContextExceptionMiniscriptException._(errorMessage),
      new_offset,
    );
  }
...
class ExpectedCharMiniscriptException extends MiniscriptException {
  final String char;
  ExpectedCharMiniscriptException(String this.char);
  ExpectedCharMiniscriptException._(String this.char);
  static LiftRetVal<ExpectedCharMiniscriptException> read(Uint8List buf) {
    ...
    final char = char_lifted.value;
    new_offset += char_lifted.bytesRead;
    return LiftRetVal(ExpectedCharMiniscriptException._(char), new_offset);
  }
...
class LiftExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  LiftExceptionMiniscriptException(String this.errorMessage);
  LiftExceptionMiniscriptException._(String this.errorMessage);
...
class MultiATooManyKeysMiniscriptException extends MiniscriptException {
  final int keys;
  MultiATooManyKeysMiniscriptException(int this.keys);
  MultiATooManyKeysMiniscriptException._(int this.keys);
  static LiftRetVal<MultiATooManyKeysMiniscriptException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final keys_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final keys = keys_lifted.value;
    new_offset += keys_lifted.bytesRead;
    return LiftRetVal(MultiATooManyKeysMiniscriptException._(keys), new_offset);
  }
...
class NonMinimalVerifyMiniscriptException extends MiniscriptException {
  final String errorMessage;
  NonMinimalVerifyMiniscriptException(String this.errorMessage);
  NonMinimalVerifyMiniscriptException._(String this.errorMessage);
...
class NonTopLevelMiniscriptException extends MiniscriptException {
  final String errorMessage;
  NonTopLevelMiniscriptException(String this.errorMessage);
  NonTopLevelMiniscriptException._(String this.errorMessage);
...
class PolicyExceptionMiniscriptException extends MiniscriptException {
  final String errorMessage;
  PolicyExceptionMiniscriptException(String this.errorMessage);
  PolicyExceptionMiniscriptException._(String this.errorMessage);
...
class ScriptMiniscriptException extends MiniscriptException {
  final String errorMessage;
  ScriptMiniscriptException(String this.errorMessage);
  ScriptMiniscriptException._(String this.errorMessage);
  static LiftRetVal<ScriptMiniscriptException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ScriptMiniscriptException._(errorMessage), new_offset);
  }
...
class SecpMiniscriptException extends MiniscriptException {
  final String errorMessage;
  SecpMiniscriptException(String this.errorMessage);
  SecpMiniscriptException._(String this.errorMessage);
  static LiftRetVal<SecpMiniscriptException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(SecpMiniscriptException._(errorMessage), new_offset);
  }
...
class TrailingMiniscriptException extends MiniscriptException {
  final String errorMessage;
  TrailingMiniscriptException(String this.errorMessage);
  TrailingMiniscriptException._(String this.errorMessage);
  static LiftRetVal<TrailingMiniscriptException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(TrailingMiniscriptException._(errorMessage), new_offset);
  }
...
class TypeCheckMiniscriptException extends MiniscriptException {
  final String errorMessage;
  TypeCheckMiniscriptException(String this.errorMessage);
  TypeCheckMiniscriptException._(String this.errorMessage);
  static LiftRetVal<TypeCheckMiniscriptException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(TypeCheckMiniscriptException._(errorMessage), new_offset);
  }
...
class UnexpectedMiniscriptException extends MiniscriptException {
  final String errorMessage;
  UnexpectedMiniscriptException(String this.errorMessage);
  UnexpectedMiniscriptException._(String this.errorMessage);
...
class UnknownWrapperMiniscriptException extends MiniscriptException {
  final String char;
  UnknownWrapperMiniscriptException(String this.char);
  UnknownWrapperMiniscriptException._(String this.char);
  static LiftRetVal<UnknownWrapperMiniscriptException> read(Uint8List buf) {
    ...
    final char = char_lifted.value;
    new_offset += char_lifted.bytesRead;
    return LiftRetVal(UnknownWrapperMiniscriptException._(char), new_offset);
  }
...
class UnprintableMiniscriptException extends MiniscriptException {
  final int byte;
  UnprintableMiniscriptException(int this.byte);
  UnprintableMiniscriptException._(int this.byte);
  static LiftRetVal<UnprintableMiniscriptException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final byte_lifted = FfiConverterUInt8.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final byte = byte_lifted.value;
    new_offset += byte_lifted.bytesRead;
    return LiftRetVal(UnprintableMiniscriptException._(byte), new_offset);
  }
...
class FfiConverterNetwork {
  static LiftRetVal<Network> read(Uint8List buf) {
    ...
    switch (index) {
      ...
      case 3:
        return LiftRetVal(Network.testnet4, 4);
      case 4:
...
class InvalidCharacterParseAmountException extends ParseAmountException {
  final String errorMessage;
  InvalidCharacterParseAmountException(String this.errorMessage);
  InvalidCharacterParseAmountException._(String this.errorMessage);
  static LiftRetVal<InvalidCharacterParseAmountException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      InvalidCharacterParseAmountException._(errorMessage),
      new_offset,
    );
  }
...
class ReasonPersistenceException extends PersistenceException {
  final String errorMessage;
  ReasonPersistenceException(String this.errorMessage);
  ReasonPersistenceException._(String this.errorMessage);
  static LiftRetVal<ReasonPersistenceException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ReasonPersistenceException._(errorMessage), new_offset);
  }
...
class PubkeyPkOrF extends PkOrF {
  final String value;
  PubkeyPkOrF(String this.value);
  PubkeyPkOrF._(String this.value);
  static LiftRetVal<PubkeyPkOrF> read(Uint8List buf) {
    ...
    final value = value_lifted.value;
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(PubkeyPkOrF._(value), new_offset);
  }
...
class XOnlyPubkeyPkOrF extends PkOrF {
  final String value;
  XOnlyPubkeyPkOrF(String this.value);
  XOnlyPubkeyPkOrF._(String this.value);
  static LiftRetVal<XOnlyPubkeyPkOrF> read(Uint8List buf) {
    ...
    final value = value_lifted.value;
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(XOnlyPubkeyPkOrF._(value), new_offset);
  }
...
class FingerprintPkOrF extends PkOrF {
  final String value;
  FingerprintPkOrF(String this.value);
  FingerprintPkOrF._(String this.value);
  static LiftRetVal<FingerprintPkOrF> read(Uint8List buf) {
    ...
    final value = value_lifted.value;
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(FingerprintPkOrF._(value), new_offset);
  }
...
class InvalidKeyPsbtException extends PsbtException {
  final String key;
  InvalidKeyPsbtException(String this.key);
  InvalidKeyPsbtException._(String this.key);
  static LiftRetVal<InvalidKeyPsbtException> read(Uint8List buf) {
    ...
    final key = key_lifted.value;
    new_offset += key_lifted.bytesRead;
    return LiftRetVal(InvalidKeyPsbtException._(key), new_offset);
  }
...
class DuplicateKeyPsbtException extends PsbtException {
  final String key;
  DuplicateKeyPsbtException(String this.key);
  DuplicateKeyPsbtException._(String this.key);
  static LiftRetVal<DuplicateKeyPsbtException> read(Uint8List buf) {
    ...
    final key = key_lifted.value;
    new_offset += key_lifted.bytesRead;
    return LiftRetVal(DuplicateKeyPsbtException._(key), new_offset);
  }
...
class NonStandardSighashTypePsbtException extends PsbtException {
  final int sighash;
  NonStandardSighashTypePsbtException(int this.sighash);
  NonStandardSighashTypePsbtException._(int this.sighash);
  static LiftRetVal<NonStandardSighashTypePsbtException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final sighash_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final sighash = sighash_lifted.value;
    new_offset += sighash_lifted.bytesRead;
    return LiftRetVal(
      NonStandardSighashTypePsbtException._(sighash),
      new_offset,
    );
  }
...
class InvalidHashPsbtException extends PsbtException {
  final String hash;
  InvalidHashPsbtException(String this.hash);
  InvalidHashPsbtException._(String this.hash);
  static LiftRetVal<InvalidHashPsbtException> read(Uint8List buf) {
    ...
    final hash = hash_lifted.value;
    new_offset += hash_lifted.bytesRead;
    return LiftRetVal(InvalidHashPsbtException._(hash), new_offset);
  }
...
class CombineInconsistentKeySourcesPsbtException extends PsbtException {
  final String xpub;
  CombineInconsistentKeySourcesPsbtException(String this.xpub);
  CombineInconsistentKeySourcesPsbtException._(String this.xpub);
  static LiftRetVal<CombineInconsistentKeySourcesPsbtException> read(
    Uint8List buf,
  ) {
    int new_offset = buf.offsetInBytes;
    final xpub_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final xpub = xpub_lifted.value;
    new_offset += xpub_lifted.bytesRead;
    return LiftRetVal(
      CombineInconsistentKeySourcesPsbtException._(xpub),
      new_offset,
    );
  }
...
class ConsensusEncodingPsbtException extends PsbtException {
  ...
  ConsensusEncodingPsbtException(String this.encodingError);
  ...
  static LiftRetVal<ConsensusEncodingPsbtException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final encodingError_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final encodingError = encodingError_lifted.value;
    new_offset += encodingError_lifted.bytesRead;
    return LiftRetVal(
      ConsensusEncodingPsbtException._(encodingError),
      new_offset,
    );
  }
...
class InvalidPublicKeyPsbtException extends PsbtException {
  final String errorMessage;
  InvalidPublicKeyPsbtException(String this.errorMessage);
  InvalidPublicKeyPsbtException._(String this.errorMessage);
...
class InvalidSecp256k1PublicKeyPsbtException extends PsbtException {
  ...
  InvalidSecp256k1PublicKeyPsbtException(String this.secp256k1Error);
  InvalidSecp256k1PublicKeyPsbtException._(String this.secp256k1Error);
  static LiftRetVal<InvalidSecp256k1PublicKeyPsbtException> read(
    Uint8List buf,
  ) {
    int new_offset = buf.offsetInBytes;
    final secp256k1Error_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final secp256k1Error = secp256k1Error_lifted.value;
    new_offset += secp256k1Error_lifted.bytesRead;
    return LiftRetVal(
      InvalidSecp256k1PublicKeyPsbtException._(secp256k1Error),
      new_offset,
    );
  }
...
class InvalidEcdsaSignaturePsbtException extends PsbtException {
  final String errorMessage;
  InvalidEcdsaSignaturePsbtException(String this.errorMessage);
  InvalidEcdsaSignaturePsbtException._(String this.errorMessage);
...
class InvalidTaprootSignaturePsbtException extends PsbtException {
  final String errorMessage;
  InvalidTaprootSignaturePsbtException(String this.errorMessage);
  InvalidTaprootSignaturePsbtException._(String this.errorMessage);
...
class TapTreePsbtException extends PsbtException {
  final String errorMessage;
  TapTreePsbtException(String this.errorMessage);
  TapTreePsbtException._(String this.errorMessage);
  static LiftRetVal<TapTreePsbtException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(TapTreePsbtException._(errorMessage), new_offset);
  }
...
class VersionPsbtException extends PsbtException {
  final String errorMessage;
  VersionPsbtException(String this.errorMessage);
  VersionPsbtException._(String this.errorMessage);
  static LiftRetVal<VersionPsbtException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(VersionPsbtException._(errorMessage), new_offset);
  }
...
class IoPsbtException extends PsbtException {
  final String errorMessage;
  IoPsbtException(String this.errorMessage);
  IoPsbtException._(String this.errorMessage);
  static LiftRetVal<IoPsbtException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(IoPsbtException._(errorMessage), new_offset);
  }
...
class InputExceptionPsbtFinalizeException extends PsbtFinalizeException {
  ...
  static LiftRetVal<InputExceptionPsbtFinalizeException> read(Uint8List buf) {
    ...
    new_offset += index_lifted.bytesRead;
    return LiftRetVal(
      InputExceptionPsbtFinalizeException._(reason, index),
      new_offset,
    );
  }
...
class WrongInputCountPsbtFinalizeException extends PsbtFinalizeException {
  ...
  WrongInputCountPsbtFinalizeException._(int this.inTx, int this.inMap);
  static LiftRetVal<WrongInputCountPsbtFinalizeException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final inTx_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final inTx = inTx_lifted.value;
    new_offset += inTx_lifted.bytesRead;
    final inMap_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final inMap = inMap_lifted.value;
    new_offset += inMap_lifted.bytesRead;
    return LiftRetVal(
      WrongInputCountPsbtFinalizeException._(inTx, inMap),
      new_offset,
    );
  }
...
class InputIdxOutofBoundsPsbtFinalizeException extends PsbtFinalizeException {
  ...
  static LiftRetVal<InputIdxOutofBoundsPsbtFinalizeException> read(
    ...
    int new_offset = buf.offsetInBytes;
    final psbtInp_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final psbtInp = psbtInp_lifted.value;
    new_offset += psbtInp_lifted.bytesRead;
    final requested_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final requested = requested_lifted.value;
    new_offset += requested_lifted.bytesRead;
    return LiftRetVal(
      InputIdxOutofBoundsPsbtFinalizeException._(psbtInp, requested),
      new_offset,
    );
  }
...
class PsbtEncodingPsbtParseException extends PsbtParseException {
  final String errorMessage;
  PsbtEncodingPsbtParseException(String this.errorMessage);
  PsbtEncodingPsbtParseException._(String this.errorMessage);
...
class Base64EncodingPsbtParseException extends PsbtParseException {
  final String errorMessage;
  Base64EncodingPsbtParseException(String this.errorMessage);
  Base64EncodingPsbtParseException._(String this.errorMessage);
...
class FfiConverterRecoveryPoint {
  ...
  static RustBuffer lower(RecoveryPoint value) {
    return value.lower();
  }

  static int allocationSize(RecoveryPoint value) {
    return value.allocationSize();
  }
...
class GenesisBlockRecoveryPoint extends RecoveryPoint {
  GenesisBlockRecoveryPoint();
  GenesisBlockRecoveryPoint._();
  static LiftRetVal<GenesisBlockRecoveryPoint> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    return LiftRetVal(GenesisBlockRecoveryPoint._(), new_offset);
  }
...
class SegwitActivationRecoveryPoint extends RecoveryPoint {
  SegwitActivationRecoveryPoint();
  SegwitActivationRecoveryPoint._();
  static LiftRetVal<SegwitActivationRecoveryPoint> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    return LiftRetVal(SegwitActivationRecoveryPoint._(), new_offset);
  }
...
class TaprootActivationRecoveryPoint extends RecoveryPoint {
  TaprootActivationRecoveryPoint();
  TaprootActivationRecoveryPoint._();
  static LiftRetVal<TaprootActivationRecoveryPoint> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    return LiftRetVal(TaprootActivationRecoveryPoint._(), new_offset);
  }
...
class OtherRecoveryPoint extends RecoveryPoint {
  final BlockId birthday;
  OtherRecoveryPoint(BlockId this.birthday);
  OtherRecoveryPoint._(BlockId this.birthday);
  static LiftRetVal<OtherRecoveryPoint> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final birthday_lifted = FfiConverterBlockId.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final birthday = birthday_lifted.value;
    new_offset += birthday_lifted.bytesRead;
    return LiftRetVal(OtherRecoveryPoint._(birthday), new_offset);
  }
  ...
  @override
  int allocationSize() {
    return FfiConverterBlockId.allocationSize(birthday) + 4;
  }
...
class PartialSatisfaction extends Satisfaction {
  ...
  static LiftRetVal<PartialSatisfaction> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final n_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    ...
    final items_lifted = FfiConverterSequenceUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final items = items_lifted.value;
    new_offset += items_lifted.bytesRead;
    final sorted_lifted = FfiConverterOptionalBool.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    ...
    return LiftRetVal(
      PartialSatisfaction._(n, m, items, sorted, conditions),
      new_offset,
    );
  }
...
class PartialCompleteSatisfaction extends Satisfaction {
  ...
  static LiftRetVal<PartialCompleteSatisfaction> read(Uint8List buf) {
    ...
    new_offset += conditions_lifted.bytesRead;
    return LiftRetVal(
      PartialCompleteSatisfaction._(n, m, items, sorted, conditions),
      new_offset,
    );
  }
...
class CompleteSatisfaction extends Satisfaction {
  ...
  CompleteSatisfaction(Condition this.condition);
  CompleteSatisfaction._(Condition this.condition);
  static LiftRetVal<CompleteSatisfaction> read(Uint8List buf) {
    ...
    return LiftRetVal(CompleteSatisfaction._(condition), new_offset);
  }
...
class NoneSatisfaction extends Satisfaction {
  final String msg;
  NoneSatisfaction(String this.msg);
  NoneSatisfaction._(String this.msg);
  static LiftRetVal<NoneSatisfaction> read(Uint8List buf) {
    ...
    return LiftRetVal(NoneSatisfaction._(msg), new_offset);
  }
...
class EcdsaSignatureSatisfiableItem extends SatisfiableItem {
  final PkOrF key;
  EcdsaSignatureSatisfiableItem(PkOrF this.key);
  EcdsaSignatureSatisfiableItem._(PkOrF this.key);
  static LiftRetVal<EcdsaSignatureSatisfiableItem> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final key_lifted = FfiConverterPkOrF.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final key = key_lifted.value;
    new_offset += key_lifted.bytesRead;
    return LiftRetVal(EcdsaSignatureSatisfiableItem._(key), new_offset);
  }
  ...
  int write(Uint8List buf) {
    buf.buffer.asByteData(buf.offsetInBytes).setInt32(0, 1);
    int new_offset = buf.offsetInBytes + 4;
    new_offset += FfiConverterPkOrF.write(
      key,
      Uint8List.view(buf.buffer, new_offset),
    );
    return new_offset;
...
class SchnorrSignatureSatisfiableItem extends SatisfiableItem {
  final PkOrF key;
  SchnorrSignatureSatisfiableItem(PkOrF this.key);
  SchnorrSignatureSatisfiableItem._(PkOrF this.key);
  static LiftRetVal<SchnorrSignatureSatisfiableItem> read(Uint8List buf) {
    ...
    final key = key_lifted.value;
    new_offset += key_lifted.bytesRead;
    return LiftRetVal(SchnorrSignatureSatisfiableItem._(key), new_offset);
  }
...
class Sha256PreimageSatisfiableItem extends SatisfiableItem {
  final String hash;
  Sha256PreimageSatisfiableItem(String this.hash);
  Sha256PreimageSatisfiableItem._(String this.hash);
  static LiftRetVal<Sha256PreimageSatisfiableItem> read(Uint8List buf) {
    ...
    final hash = hash_lifted.value;
    new_offset += hash_lifted.bytesRead;
    return LiftRetVal(Sha256PreimageSatisfiableItem._(hash), new_offset);
  }
...
class Hash256PreimageSatisfiableItem extends SatisfiableItem {
  final String hash;
  Hash256PreimageSatisfiableItem(String this.hash);
  Hash256PreimageSatisfiableItem._(String this.hash);
  static LiftRetVal<Hash256PreimageSatisfiableItem> read(Uint8List buf) {
    ...
    final hash = hash_lifted.value;
    new_offset += hash_lifted.bytesRead;
    return LiftRetVal(Hash256PreimageSatisfiableItem._(hash), new_offset);
  }
...
class Ripemd160PreimageSatisfiableItem extends SatisfiableItem {
  final String hash;
  Ripemd160PreimageSatisfiableItem(String this.hash);
  Ripemd160PreimageSatisfiableItem._(String this.hash);
  static LiftRetVal<Ripemd160PreimageSatisfiableItem> read(Uint8List buf) {
    ...
    final hash = hash_lifted.value;
    new_offset += hash_lifted.bytesRead;
    return LiftRetVal(Ripemd160PreimageSatisfiableItem._(hash), new_offset);
  }
...
class Hash160PreimageSatisfiableItem extends SatisfiableItem {
  final String hash;
  Hash160PreimageSatisfiableItem(String this.hash);
  Hash160PreimageSatisfiableItem._(String this.hash);
  static LiftRetVal<Hash160PreimageSatisfiableItem> read(Uint8List buf) {
    ...
    final hash = hash_lifted.value;
    new_offset += hash_lifted.bytesRead;
    return LiftRetVal(Hash160PreimageSatisfiableItem._(hash), new_offset);
  }
...
class AbsoluteTimelockSatisfiableItem extends SatisfiableItem {
  ...
  AbsoluteTimelockSatisfiableItem(LockTime this.value);
  AbsoluteTimelockSatisfiableItem._(LockTime this.value);
  static LiftRetVal<AbsoluteTimelockSatisfiableItem> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final value_lifted = FfiConverterLockTime.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final value = value_lifted.value;
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(AbsoluteTimelockSatisfiableItem._(value), new_offset);
  }
...
class RelativeTimelockSatisfiableItem extends SatisfiableItem {
  final int value;
  RelativeTimelockSatisfiableItem(int this.value);
  RelativeTimelockSatisfiableItem._(int this.value);
  static LiftRetVal<RelativeTimelockSatisfiableItem> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final value_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final value = value_lifted.value;
    new_offset += value_lifted.bytesRead;
    return LiftRetVal(RelativeTimelockSatisfiableItem._(value), new_offset);
  }
...
class MultisigSatisfiableItem extends SatisfiableItem {
  ...
  MultisigSatisfiableItem._(List<PkOrF> this.keys, int this.threshold);
  static LiftRetVal<MultisigSatisfiableItem> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final keys_lifted = FfiConverterSequencePkOrF.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final keys = keys_lifted.value;
    new_offset += keys_lifted.bytesRead;
    final threshold_lifted = FfiConverterUInt64.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final threshold = threshold_lifted.value;
    new_offset += threshold_lifted.bytesRead;
    return LiftRetVal(MultisigSatisfiableItem._(keys, threshold), new_offset);
  }
...
class ThreshSatisfiableItem extends SatisfiableItem {
  ...
  ThreshSatisfiableItem._(List<Policy> this.items, int this.threshold);
  static LiftRetVal<ThreshSatisfiableItem> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final items_lifted = FfiConverterSequencePolicy.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final items = items_lifted.value;
    new_offset += items_lifted.bytesRead;
    ...
    final threshold = threshold_lifted.value;
    new_offset += threshold_lifted.bytesRead;
    return LiftRetVal(ThreshSatisfiableItem._(items, threshold), new_offset);
  }
...
class RecoveryScanType extends ScanType {
  ...
  RecoveryScanType._(int this.usedScriptIndex, RecoveryPoint this.checkpoint);
  static LiftRetVal<RecoveryScanType> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final usedScriptIndex_lifted = FfiConverterUInt32.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final usedScriptIndex = usedScriptIndex_lifted.value;
    new_offset += usedScriptIndex_lifted.bytesRead;
    final checkpoint_lifted = FfiConverterRecoveryPoint.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final checkpoint = checkpoint_lifted.value;
    new_offset += checkpoint_lifted.bytesRead;
    return LiftRetVal(
      RecoveryScanType._(usedScriptIndex, checkpoint),
      new_offset,
    );
  }
  ...
  @override
  int allocationSize() {
    return FfiConverterUInt32.allocationSize(usedScriptIndex) +
        FfiConverterRecoveryPoint.allocationSize(checkpoint) +
        4;
  }
  ...
  int write(Uint8List buf) {
    ...
    new_offset += FfiConverterRecoveryPoint.write(
      checkpoint,
      Uint8List.view(buf.buffer, new_offset),
    );
    return new_offset;
...
class SighashP2wpkhSignerException extends SignerException {
  final String errorMessage;
  SighashP2wpkhSignerException(String this.errorMessage);
  SighashP2wpkhSignerException._(String this.errorMessage);
  static LiftRetVal<SighashP2wpkhSignerException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(SighashP2wpkhSignerException._(errorMessage), new_offset);
  }
...
class SighashTaprootSignerException extends SignerException {
  final String errorMessage;
  SighashTaprootSignerException(String this.errorMessage);
  SighashTaprootSignerException._(String this.errorMessage);
  static LiftRetVal<SighashTaprootSignerException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      SighashTaprootSignerException._(errorMessage),
      new_offset,
    );
  }
...
class TxInputsIndexExceptionSignerException extends SignerException {
  final String errorMessage;
  TxInputsIndexExceptionSignerException(String this.errorMessage);
  TxInputsIndexExceptionSignerException._(String this.errorMessage);
...
class MiniscriptPsbtSignerException extends SignerException {
  final String errorMessage;
  MiniscriptPsbtSignerException(String this.errorMessage);
  MiniscriptPsbtSignerException._(String this.errorMessage);
  static LiftRetVal<MiniscriptPsbtSignerException> read(Uint8List buf) {
    ...
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(
      MiniscriptPsbtSignerException._(errorMessage),
      new_offset,
    );
  }
...
class ExternalSignerException extends SignerException {
  final String errorMessage;
  ExternalSignerException(String this.errorMessage);
  ExternalSignerException._(String this.errorMessage);
  static LiftRetVal<ExternalSignerException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(ExternalSignerException._(errorMessage), new_offset);
  }
...
class PsbtSignerException extends SignerException {
  final String errorMessage;
  PsbtSignerException(String this.errorMessage);
  PsbtSignerException._(String this.errorMessage);
  static LiftRetVal<PsbtSignerException> read(Uint8List buf) {
    ...
    final errorMessage = errorMessage_lifted.value;
    new_offset += errorMessage_lifted.bytesRead;
    return LiftRetVal(PsbtSignerException._(errorMessage), new_offset);
  }
...
class InvalidChecksumTransactionException extends TransactionException {
  ...
  static LiftRetVal<InvalidChecksumTransactionException> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final expected_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final expected = expected_lifted.value;
    new_offset += expected_lifted.bytesRead;
    final actual_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final actual = actual_lifted.value;
    new_offset += actual_lifted.bytesRead;
    return LiftRetVal(
      InvalidChecksumTransactionException._(expected, actual),
      new_offset,
    );
  }
...
class UnsupportedSegwitFlagTransactionException extends TransactionException {
  final int flag;
  UnsupportedSegwitFlagTransactionException(int this.flag);
  UnsupportedSegwitFlagTransactionException._(int this.flag);
  static LiftRetVal<UnsupportedSegwitFlagTransactionException> read(
    Uint8List buf,
  ) {
    int new_offset = buf.offsetInBytes;
    final flag_lifted = FfiConverterUInt8.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final flag = flag_lifted.value;
    new_offset += flag_lifted.bytesRead;
    return LiftRetVal(
      UnsupportedSegwitFlagTransactionException._(flag),
      new_offset,
    );
  }
...
class InvalidTxidTxidParseException extends TxidParseException {
  final String txid;
  InvalidTxidTxidParseException(String this.txid);
  InvalidTxidTxidParseException._(String this.txid);
  static LiftRetVal<InvalidTxidTxidParseException> read(Uint8List buf) {
    ...
    final txid = txid_lifted.value;
    new_offset += txid_lifted.bytesRead;
    return LiftRetVal(InvalidTxidTxidParseException._(txid), new_offset);
  }
...
class FfiConverterWalletEvent {
  static WalletEvent lift(RustBuffer buffer) {
    return FfiConverterWalletEvent.read(buffer.asUint8List()).value;
  }

  static LiftRetVal<WalletEvent> read(Uint8List buf) {
    final index = buf.buffer.asByteData(buf.offsetInBytes).getInt32(0);
    final subview = Uint8List.view(buf.buffer, buf.offsetInBytes + 4);
    switch (index) {
      case 1:
  ...
  static RustBuffer lower(WalletEvent value) {
    return value.lower();
  }

  static int allocationSize(WalletEvent value) {
    return value.allocationSize();
  }
...
class ChainTipChangedWalletEvent extends WalletEvent {
  final BlockId oldTip;
  final BlockId newTip;
  ChainTipChangedWalletEvent({
    required BlockId this.oldTip,
    required BlockId this.newTip,
  });
  ChainTipChangedWalletEvent._(BlockId this.oldTip, BlockId this.newTip);
  static LiftRetVal<ChainTipChangedWalletEvent> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final oldTip_lifted = FfiConverterBlockId.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final oldTip = oldTip_lifted.value;
    new_offset += oldTip_lifted.bytesRead;
    final newTip_lifted = FfiConverterBlockId.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final newTip = newTip_lifted.value;
    new_offset += newTip_lifted.bytesRead;
    return LiftRetVal(ChainTipChangedWalletEvent._(oldTip, newTip), new_offset);
  }
  ...
  @override
  int allocationSize() {
    return FfiConverterBlockId.allocationSize(oldTip) +
        FfiConverterBlockId.allocationSize(newTip) +
        4;
  }
...
class TxConfirmedWalletEvent extends WalletEvent {
  final Txid txid;
  final Transaction tx;
  final ConfirmationBlockTime blockTime;
  final ConfirmationBlockTime? oldBlockTime;
  TxConfirmedWalletEvent({
    required Txid this.txid,
    required Transaction this.tx,
    required ConfirmationBlockTime this.blockTime,
    required ConfirmationBlockTime? this.oldBlockTime,
  });
  TxConfirmedWalletEvent._(
    Txid this.txid,
    Transaction this.tx,
    ConfirmationBlockTime this.blockTime,
    ConfirmationBlockTime? this.oldBlockTime,
  );
  static LiftRetVal<TxConfirmedWalletEvent> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final txid_lifted = Txid.read(Uint8List.view(buf.buffer, new_offset));
    final txid = txid_lifted.value;
    new_offset += txid_lifted.bytesRead;
    ...
    final tx = tx_lifted.value;
    new_offset += tx_lifted.bytesRead;
    final blockTime_lifted = FfiConverterConfirmationBlockTime.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final blockTime = blockTime_lifted.value;
    new_offset += blockTime_lifted.bytesRead;
    final oldBlockTime_lifted = FfiConverterOptionalConfirmationBlockTime.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final oldBlockTime = oldBlockTime_lifted.value;
    new_offset += oldBlockTime_lifted.bytesRead;
    return LiftRetVal(
      TxConfirmedWalletEvent._(txid, tx, blockTime, oldBlockTime),
      new_offset,
    );
  }
  ...
  @override
  int allocationSize() {
    return Txid.allocationSize(txid) +
        Transaction.allocationSize(tx) +
        FfiConverterConfirmationBlockTime.allocationSize(blockTime) +
        FfiConverterOptionalConfirmationBlockTime.allocationSize(oldBlockTime) +
        4;
  }
  ...
  int write(Uint8List buf) {
    buf.buffer.asByteData(buf.offsetInBytes).setInt32(0, 2);
    int new_offset = buf.offsetInBytes + 4;
    new_offset += Txid.write(txid, Uint8List.view(buf.buffer, new_offset));
    new_offset += Transaction.write(tx, Uint8List.view(buf.buffer, new_offset));
    new_offset += FfiConverterConfirmationBlockTime.write(
      blockTime,
      Uint8List.view(buf.buffer, new_offset),
    );
    new_offset += FfiConverterOptionalConfirmationBlockTime.write(
      oldBlockTime,
      Uint8List.view(buf.buffer, new_offset),
    );
    return new_offset;
...
class TxUnconfirmedWalletEvent extends WalletEvent {
  final Txid txid;
  final Transaction tx;
  final ConfirmationBlockTime? oldBlockTime;
  TxUnconfirmedWalletEvent({
    required Txid this.txid,
    required Transaction this.tx,
    required ConfirmationBlockTime? this.oldBlockTime,
  });
  TxUnconfirmedWalletEvent._(
    Txid this.txid,
    Transaction this.tx,
    ConfirmationBlockTime? this.oldBlockTime,
  );
  static LiftRetVal<TxUnconfirmedWalletEvent> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final txid_lifted = Txid.read(Uint8List.view(buf.buffer, new_offset));
    final txid = txid_lifted.value;
    new_offset += txid_lifted.bytesRead;
    ...
    new_offset += oldBlockTime_lifted.bytesRead;
    return LiftRetVal(
      TxUnconfirmedWalletEvent._(txid, tx, oldBlockTime),
      new_offset,
    );
  }
...
class TxReplacedWalletEvent extends WalletEvent {
  final Txid txid;
  final Transaction tx;
  final List<Conflict> conflicts;
  TxReplacedWalletEvent({
    required Txid this.txid,
    required Transaction this.tx,
    required List<Conflict> this.conflicts,
  });
  TxReplacedWalletEvent._(
    Txid this.txid,
    Transaction this.tx,
    List<Conflict> this.conflicts,
  );
  static LiftRetVal<TxReplacedWalletEvent> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final txid_lifted = Txid.read(Uint8List.view(buf.buffer, new_offset));
    final txid = txid_lifted.value;
    new_offset += txid_lifted.bytesRead;
    ...
    final tx = tx_lifted.value;
    new_offset += tx_lifted.bytesRead;
    final conflicts_lifted = FfiConverterSequenceConflict.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final conflicts = conflicts_lifted.value;
    new_offset += conflicts_lifted.bytesRead;
    return LiftRetVal(TxReplacedWalletEvent._(txid, tx, conflicts), new_offset);
  }
  ...
  int allocationSize() {
    return Txid.allocationSize(txid) +
        Transaction.allocationSize(tx) +
        FfiConverterSequenceConflict.allocationSize(conflicts) +
        4;
  }
  ...
  int write(Uint8List buf) {
    ...
    new_offset += Txid.write(txid, Uint8List.view(buf.buffer, new_offset));
    new_offset += Transaction.write(tx, Uint8List.view(buf.buffer, new_offset));
    new_offset += FfiConverterSequenceConflict.write(
      conflicts,
      Uint8List.view(buf.buffer, new_offset),
    );
    return new_offset;
...
class TxDroppedWalletEvent extends WalletEvent {
  final Txid txid;
  final Transaction tx;
  TxDroppedWalletEvent({required Txid this.txid, required Transaction this.tx});
  TxDroppedWalletEvent._(Txid this.txid, Transaction this.tx);
  static LiftRetVal<TxDroppedWalletEvent> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final txid_lifted = Txid.read(Uint8List.view(buf.buffer, new_offset));
    final txid = txid_lifted.value;
    new_offset += txid_lifted.bytesRead;
    ...
    final tx = tx_lifted.value;
    new_offset += tx_lifted.bytesRead;
    return LiftRetVal(TxDroppedWalletEvent._(txid, tx), new_offset);
  }
  ...
  @override
  int allocationSize() {
    return Txid.allocationSize(txid) + Transaction.allocationSize(tx) + 4;
  }
...
class TransactionRejectedWarning extends Warning {
  ...
  TransactionRejectedWarning._(String this.wtxid, String? this.reason);
  static LiftRetVal<TransactionRejectedWarning> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final wtxid_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final wtxid = wtxid_lifted.value;
    new_offset += wtxid_lifted.bytesRead;
    final reason_lifted = FfiConverterOptionalString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final reason = reason_lifted.value;
    new_offset += reason_lifted.bytesRead;
    return LiftRetVal(TransactionRejectedWarning._(wtxid, reason), new_offset);
  }
...
class UnexpectedSyncExceptionWarning extends Warning {
  ...
  UnexpectedSyncExceptionWarning(String this.warning);
  UnexpectedSyncExceptionWarning._(String this.warning);
  static LiftRetVal<UnexpectedSyncExceptionWarning> read(Uint8List buf) {
    int new_offset = buf.offsetInBytes;
    final warning_lifted = FfiConverterString.read(
      Uint8List.view(buf.buffer, new_offset),
    );
    final warning = warning_lifted.value;
    new_offset += warning_lifted.bytesRead;
    return LiftRetVal(UnexpectedSyncExceptionWarning._(warning), new_offset);
  }
...
enum WordCount { words12, words15, words18, words21, words24 }
...
class FfiConverterWordCount {
  static LiftRetVal<WordCount> read(Uint8List buf) {
    ...
    switch (index) {
      case 1:
        return LiftRetVal(WordCount.words12, 4);
      case 2:
        return LiftRetVal(WordCount.words15, 4);
      case 3:
        return LiftRetVal(WordCount.words18, 4);
      case 4:
        return LiftRetVal(WordCount.words21, 4);
      case 5:
        return LiftRetVal(WordCount.words24, 4);
      default:
        throw UniffiInternalError(
          UniffiInternalError.unexpectedEnumCase,
          "Unable to determine enum variant",
...
final _AddressFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_address(ptr, status));
});
...
class Address implements AddressInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_address(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_address(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_address_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_address_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        Address.lower(other),
        status,
      ),
  ...
  Script scriptPubkey() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_address_script_pubkey(
        uniffiClonePointer(),
        status,
      ),
      Script.lift,
  ...
  AddressData toAddressData() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_address_to_address_data(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterAddressData.lift,
      null,
    );
  }
  ...
  String toQrUri() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_address_to_qr_uri(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
...
final _AmountFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_amount(ptr, status));
});
...
class Amount implements AmountInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_amount(_ptr, status));
  }
  ...
  double toBtc() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_amount_to_btc(uniffiClonePointer(), status),
  ...
  int toSat() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_amount_to_sat(uniffiClonePointer(), status),
...
final _BlockHashFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_blockhash(ptr, status));
});
...
class BlockHash implements BlockHashInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_blockhash(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_blockhash(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_blockhash_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_blockhash_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        BlockHash.lower(other),
        status,
      ),
      FfiConverterBool.lift,
      null,
  ...
  int get hashCode {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_blockhash_uniffi_trait_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  Uint8List serialize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_blockhash_serialize(
        uniffiClonePointer(),
        status,
      ),
...
final _BumpFeeTxBuilderFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_bumpfeetxbuilder(ptr, status));
});
...
class BumpFeeTxBuilder implements BumpFeeTxBuilderInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_bumpfeetxbuilder(_ptr, status),
    );
  }
...
final _CbfBuilderFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_cbfbuilder(ptr, status));
});
...
class CbfBuilder implements CbfBuilderInterface {
  ...
  CbfBuilder()
    : _ptr = rustCall(
        (status) => uniffi_bdkffi_fn_constructor_cbfbuilder_new(status),
        null,
      ) {
    _CbfBuilderFinalizer.attach(this, _ptr, detach: this);
  }
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_cbfbuilder(_ptr, status),
    );
  }
  ...
  CbfComponents build(Wallet wallet) {
    return rustCallWithLifter(
      ...
      FfiConverterCbfComponents.lift,
      null,
    );
  }
  ...
  CbfBuilder peers(List<Peer> peers) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_cbfbuilder_peers(
        uniffiClonePointer(),
        FfiConverterSequencePeer.lower(peers),
        status,
      ),
      CbfBuilder.lift,
      null,
  ...
  CbfBuilder scanType(ScanType scanType) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_cbfbuilder_scan_type(
        uniffiClonePointer(),
        FfiConverterScanType.lower(scanType),
        status,
      ),
      CbfBuilder.lift,
      null,
...
final _CbfClientFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_cbfclient(ptr, status));
});
...
class CbfClient implements CbfClientInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_cbfclient(_ptr, status));
  }
  ...
  Future<FeeRate> averageFeeRate(BlockHash blockhash) {
    return uniffiRustCallAsync(
      ...
      ffi_bdkffi_rust_future_complete_u64,
  ...
  bool isRunning() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_cbfclient_is_running(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  List<IpAddress> lookupHost(String hostname) {
    return rustCallWithLifter(
      ...
      FfiConverterSequenceIpAddress.lift,
      null,
    );
  }
  ...
  Future<Info> nextInfo() {
    return uniffiRustCallAsync(
      () => uniffi_bdkffi_fn_method_cbfclient_next_info(uniffiClonePointer()),
  ...
  Future<Warning> nextWarning() {
    return uniffiRustCallAsync(
      () =>
          uniffi_bdkffi_fn_method_cbfclient_next_warning(uniffiClonePointer()),
      ffi_bdkffi_rust_future_poll_rust_buffer,
      ffi_bdkffi_rust_future_complete_rust_buffer,
      ffi_bdkffi_rust_future_free_rust_buffer,
  ...
  void shutdown() {
    return rustCall((status) {
      uniffi_bdkffi_fn_method_cbfclient_shutdown(uniffiClonePointer(), status);
    }, cbfExceptionErrorHandler);
  }

  Future<Update> update() {
    return uniffiRustCallAsync(
      () => uniffi_bdkffi_fn_method_cbfclient_update(uniffiClonePointer()),
      ffi_bdkffi_rust_future_poll_u64,
      ffi_bdkffi_rust_future_complete_u64,
      ffi_bdkffi_rust_future_free_u64,
...
final _CbfNodeFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_cbfnode(ptr, status));
});
...
class CbfNode implements CbfNodeInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_cbfnode(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_cbfnode(_ptr, status));
  }
...
final _ChangeSetFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_changeset(ptr, status));
});
...
class ChangeSet implements ChangeSetInterface {
    ...
    : _ptr = rustCall(
        (status) =>
            uniffi_bdkffi_fn_constructor_changeset_from_indexer_changeset(
              FfiConverterIndexerChangeSet.lower(indexerChanges),
              status,
            ),
        null,
      ) {
  ...
  ChangeSet()
    : _ptr = rustCall(
        (status) => uniffi_bdkffi_fn_constructor_changeset_new(status),
        null,
      ) {
    _ChangeSetFinalizer.attach(this, _ptr, detach: this);
  }
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_changeset(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_changeset(_ptr, status));
  }

  Descriptor? changeDescriptor() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_change_descriptor(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterOptionalDescriptor.lift,
      null,
    );
  }
  ...
  Descriptor? descriptor() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_descriptor(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterOptionalDescriptor.lift,
  ...
  IndexerChangeSet indexerChangeset() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_indexer_changeset(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterIndexerChangeSet.lift,
      null,
    );
  }
  ...
  LocalChainChangeSet localchainChangeset() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_localchain_changeset(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterLocalChainChangeSet.lift,
      null,
    );
  }
  ...
  Network? network() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_network(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterOptionalNetwork.lift,
      null,
    );
  }
  ...
  TxGraphChangeSet txGraphChangeset() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_changeset_tx_graph_changeset(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterTxGraphChangeSet.lift,
      null,
    );
  }
}
...
final _DerivationPathFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_derivationpath(ptr, status));
});
...
class DerivationPath implements DerivationPathInterface {
  ...
  DerivationPath.master()
    : _ptr = rustCall(
        (status) => uniffi_bdkffi_fn_constructor_derivationpath_master(status),
        null,
      ) {
    _DerivationPathFinalizer.attach(this, _ptr, detach: this);
  }
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_derivationpath(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_derivationpath(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_derivationpath_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool isMaster() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_derivationpath_is_master(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  int len() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_derivationpath_len(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
...
class Descriptor implements DescriptorInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_descriptor(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_descriptor(_ptr, status));
  }

  String debugString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_uniffi_trait_debug(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  DescriptorType descType() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_desc_type(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterDescriptorType.lift,
      null,
    );
  }
  ...
  DescriptorId descriptorId() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_descriptor_id(
        uniffiClonePointer(),
        status,
      ),
      DescriptorId.lift,
  ...
  bool isMultipath() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_is_multipath(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  int maxWeightToSatisfy() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_max_weight_to_satisfy(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  List<Descriptor> toSingleDescriptors() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_to_single_descriptors(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceDescriptor.lift,
      miniscriptExceptionErrorHandler,
    );
  }
  ...
  String toStringWithSecret() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptor_to_string_with_secret(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
...
final _DescriptorIdFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_descriptorid(ptr, status));
});
...
class DescriptorId implements DescriptorIdInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_descriptorid(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_descriptorid(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        DescriptorId.lower(other),
        status,
      ),
      FfiConverterBool.lift,
      null,
  ...
  int get hashCode {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
...
final _DescriptorPublicKeyFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_descriptorpublickey(ptr, status));
});
...
class DescriptorPublicKey implements DescriptorPublicKeyInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_descriptorpublickey(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall(
      (status) => uniffi_bdkffi_fn_free_descriptorpublickey(_ptr, status),
    );
  }
  ...
  DescriptorPublicKey derive(DerivationPath path) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorpublickey_derive(
        uniffiClonePointer(),
        DerivationPath.lower(path),
        status,
      ),
      DescriptorPublicKey.lift,
      descriptorKeyExceptionErrorHandler,
    );
  }
  ...
  bool isMultipath() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorpublickey_is_multipath(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
...
final _DescriptorSecretKeyFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_descriptorsecretkey(ptr, status));
});
...
class DescriptorSecretKey implements DescriptorSecretKeyInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_descriptorsecretkey(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall(
      (status) => uniffi_bdkffi_fn_free_descriptorsecretkey(_ptr, status),
    );
  }
  ...
  DescriptorPublicKey asPublic() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorsecretkey_as_public(
        uniffiClonePointer(),
        status,
      ),
      DescriptorPublicKey.lift,
  ...
  Uint8List secretBytes() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_descriptorsecretkey_secret_bytes(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUint8List.lift,
...
class ElectrumClient implements ElectrumClientInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_electrumclient(_ptr, status),
    );
  }
  ...
  HeaderNotification blockHeadersSubscribe() {
    return rustCallWithLifter(
      ...
      FfiConverterHeaderNotification.lift,
      electrumExceptionErrorHandler,
    );
  }
  ...
  void ping() {
    return rustCall((status) {
      uniffi_bdkffi_fn_method_electrumclient_ping(uniffiClonePointer(), status);
    }, electrumExceptionErrorHandler);
  }
  ...
  ServerFeaturesRes serverFeatures() {
    return rustCallWithLifter(
      ...
      FfiConverterServerFeaturesRes.lift,
      electrumExceptionErrorHandler,
    );
  }
...
class EsploraClient implements EsploraClientInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_esploraclient(_ptr, status),
    );
  }
  ...
  Map<int, double> getFeeEstimates() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_esploraclient_get_fee_estimates(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterMapUInt16ToDouble64.lift,
      esploraExceptionErrorHandler,
    );
  }
...
final _FeeRateFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_feerate(ptr, status));
});
...
class FeeRate implements FeeRateInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_feerate(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_feerate(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_feerate_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  int toSatPerKwu() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_feerate_to_sat_per_kwu(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  int toSatPerVbCeil() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_feerate_to_sat_per_vb_ceil(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  int toSatPerVbFloor() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_feerate_to_sat_per_vb_floor(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
...
final _FullScanRequestFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_fullscanrequest(ptr, status));
});
...
class FullScanRequest implements FullScanRequestInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_fullscanrequest(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_fullscanrequest(_ptr, status));
  }
}
...
final _FullScanRequestBuilderFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall(
    (status) => uniffi_bdkffi_fn_free_fullscanrequestbuilder(ptr, status),
  );
});
...
class FullScanRequestBuilder implements FullScanRequestBuilderInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_fullscanrequestbuilder(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall(
      (status) => uniffi_bdkffi_fn_free_fullscanrequestbuilder(_ptr, status),
    );
  }

  FullScanRequest build() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_fullscanrequestbuilder_build(
        uniffiClonePointer(),
        status,
      ),
      FullScanRequest.lift,
      requestBuilderExceptionErrorHandler,
    );
  }
...
abstract class FullScanScriptInspector {
  void inspect(KeychainKind keychain, int index, Script script);
}
...
typedef UniffiCallbackInterfaceFullScanScriptInspectorMethod0 =
    Void Function(
      Uint64,
      Int32,
      Uint32,
...
typedef UniffiCallbackInterfaceFullScanScriptInspectorFree =
    Void Function(Uint64);
typedef UniffiCallbackInterfaceFullScanScriptInspectorFreeDart =
    void Function(int);
typedef UniffiCallbackInterfaceFullScanScriptInspectorClone =
    Uint64 Function(Uint64);
typedef UniffiCallbackInterfaceFullScanScriptInspectorCloneDart =
    int Function(int);
...
final class UniffiVTableCallbackInterfaceFullScanScriptInspector
  ...
  uniffiFree;
  external Pointer<
    NativeFunction<UniffiCallbackInterfaceFullScanScriptInspectorClone>
  >
  uniffiClone;
  external Pointer<
...
void fullScanScriptInspectorInspect(
  ...
  try {
    final obj = FfiConverterCallbackInterfaceFullScanScriptInspector._handleMap
        .get(uniffiHandle);
    final arg0 = FfiConverterKeychainKind.read(
      createUint8ListFromInt(keychain),
    ).value;
    final arg1 = FfiConverterUInt32.lift(index);
    final arg2 = Script.lift(script);
    obj.inspect(arg0, arg1, arg2);
...
void fullScanScriptInspectorFreeCallback(int handle) {
  try {
    FfiConverterCallbackInterfaceFullScanScriptInspector._handleMap.remove(
      handle,
    );
  } catch (e) {}
}
...
int fullScanScriptInspectorCloneCallback(int handle) {
  try {
    final obj = FfiConverterCallbackInterfaceFullScanScriptInspector._handleMap
        .get(handle);
    final newHandle = FfiConverterCallbackInterfaceFullScanScriptInspector
        ._handleMap
        .insert(obj);
    return newHandle;
  } catch (e) {
...
final Pointer<
  NativeFunction<UniffiCallbackInterfaceFullScanScriptInspectorClone>
>
fullScanScriptInspectorClonePointer =
    Pointer.fromFunction<UniffiCallbackInterfaceFullScanScriptInspectorClone>(
      fullScanScriptInspectorCloneCallback,
      0,
    );
...
void initFullScanScriptInspectorVTable() {
  ...
  fullScanScriptInspectorVTable.ref.uniffiFree =
      fullScanScriptInspectorFreePointer;
  fullScanScriptInspectorVTable.ref.uniffiClone =
      fullScanScriptInspectorClonePointer;
...
final _HashableOutPointFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_hashableoutpoint(ptr, status));
});
...
class HashableOutPoint implements HashableOutPointInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_hashableoutpoint(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_hashableoutpoint(_ptr, status));
  }

  String debugString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_hashableoutpoint_uniffi_trait_debug(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  OutPoint outpoint() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_hashableoutpoint_outpoint(
        uniffiClonePointer(),
        status,
      ),
...
final _IpAddressFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_ipaddress(ptr, status));
});
...
class IpAddress implements IpAddressInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_ipaddress(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_ipaddress(_ptr, status));
  }
}

abstract class LeafNodeInterface {
  int depth();
  String? leafHash();
  int? leafVersion();
...
final _LeafNodeFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_leafnode(ptr, status));
});

class LeafNode implements LeafNodeInterface {
  late final Pointer<Void> _ptr;
  LeafNode._(this._ptr) {
    _LeafNodeFinalizer.attach(this, _ptr, detach: this);
  }
  factory LeafNode.lift(Pointer<Void> ptr) {
    return LeafNode._(ptr);
  }
  static Pointer<Void> lower(LeafNode value) {
    return value.uniffiClonePointer();
  }

  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_leafnode(_ptr, status));
  }

  static int allocationSize(LeafNode value) {
    return 8;
  }

  static LiftRetVal<LeafNode> read(Uint8List buf) {
    final handle = buf.buffer.asByteData(buf.offsetInBytes).getInt64(0);
    final pointer = Pointer<Void>.fromAddress(handle);
    return LiftRetVal(LeafNode.lift(pointer), 8);
  }

  static int write(LeafNode value, Uint8List buf) {
    final handle = lower(value);
    buf.buffer.asByteData(buf.offsetInBytes).setInt64(0, handle.address);
    return 8;
  }
  ...
  void dispose() {
    _LeafNodeFinalizer.detach(this);
    rustCall((status) => uniffi_bdkffi_fn_free_leafnode(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_leafnode_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  int depth() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_leafnode_depth(uniffiClonePointer(), status),
  ...
  String? leafHash() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_leafnode_leaf_hash(
        uniffiClonePointer(),
        status,
      ),
  ...
  int? leafVersion() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_leafnode_leaf_version(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterOptionalUInt8.lift,
      null,
    );
  }
  ...
  String nodeHash() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_leafnode_node_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  Script? script() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_leafnode_script(uniffiClonePointer(), status),
      FfiConverterOptionalScript.lift,
      null,
    );
  }
}
...
class Mnemonic implements MnemonicInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_mnemonic(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_mnemonic(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_mnemonic_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
...
abstract class NodeInfoInterface {
  List<LeafNode> leafNodes();
  String nodeHash();
}

final _NodeInfoFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_nodeinfo(ptr, status));
});

class NodeInfo implements NodeInfoInterface {
  late final Pointer<Void> _ptr;
  NodeInfo._(this._ptr) {
    _NodeInfoFinalizer.attach(this, _ptr, detach: this);
  }
  factory NodeInfo.lift(Pointer<Void> ptr) {
    return NodeInfo._(ptr);
  }
  static Pointer<Void> lower(NodeInfo value) {
    return value.uniffiClonePointer();
  }

  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_nodeinfo(_ptr, status));
  }

  static int allocationSize(NodeInfo value) {
    return 8;
  }

  static LiftRetVal<NodeInfo> read(Uint8List buf) {
    final handle = buf.buffer.asByteData(buf.offsetInBytes).getInt64(0);
    final pointer = Pointer<Void>.fromAddress(handle);
    return LiftRetVal(NodeInfo.lift(pointer), 8);
  }

  static int write(NodeInfo value, Uint8List buf) {
    final handle = lower(value);
    buf.buffer.asByteData(buf.offsetInBytes).setInt64(0, handle.address);
    return 8;
  }
  ...
  void dispose() {
    _NodeInfoFinalizer.detach(this);
    rustCall((status) => uniffi_bdkffi_fn_free_nodeinfo(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_nodeinfo_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  List<LeafNode> leafNodes() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_nodeinfo_leaf_nodes(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceLeafNode.lift,
      null,
    );
  }
  ...
  String nodeHash() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_nodeinfo_node_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
...
typedef UniffiCallbackInterfacePersistenceMethod0 =
    Void Function(Uint64, Pointer<Pointer<Void>>, Pointer<RustCallStatus>);
typedef UniffiCallbackInterfacePersistenceMethod0Dart =
    void Function(int, Pointer<Pointer<Void>>, Pointer<RustCallStatus>);
typedef UniffiCallbackInterfacePersistenceMethod1 =
    Void Function(
      Uint64,
      Pointer<Void>,
      Pointer<Void>,
...
typedef UniffiCallbackInterfacePersistenceMethod1Dart =
    void Function(int, Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>);
...
typedef UniffiCallbackInterfacePersistenceClone = Uint64 Function(Uint64);
typedef UniffiCallbackInterfacePersistenceCloneDart = int Function(int);
...
final class UniffiVTableCallbackInterfacePersistence extends Struct {
  ...
  uniffiFree;
  external Pointer<NativeFunction<UniffiCallbackInterfacePersistenceClone>>
  uniffiClone;
...
void persistenceInitialize(
  int uniffiHandle,
  Pointer<Pointer<Void>> outReturn,
  Pointer<RustCallStatus> callStatus,
) {
  final status = callStatus.ref;
  try {
    final obj = FfiConverterCallbackInterfacePersistence._handleMap.get(
      uniffiHandle,
    );
...
void persistencePersist(
  int uniffiHandle,
  Pointer<Void> changeset,
  Pointer<Void> outReturn,
  Pointer<RustCallStatus> callStatus,
) {
  final status = callStatus.ref;
...
int persistenceCloneCallback(int handle) {
  try {
    final obj = FfiConverterCallbackInterfacePersistence._handleMap.get(handle);
    final newHandle = FfiConverterCallbackInterfacePersistence._handleMap
        .insert(obj);
    return newHandle;
  } catch (e) {
    return 0;
...
final Pointer<NativeFunction<UniffiCallbackInterfacePersistenceClone>>
persistenceClonePointer =
    Pointer.fromFunction<UniffiCallbackInterfacePersistenceClone>(
      persistenceCloneCallback,
      0,
    );
...
void initPersistenceVTable() {
  ...
  persistenceVTable.ref.uniffiClone = persistenceClonePointer;
  persistenceVTable.ref.initialize = persistenceInitializePointer;
  persistenceVTable.ref.persist = persistencePersistPointer;
  rustCall((status) {
    uniffi_bdkffi_fn_init_callback_vtable_persistence(persistenceVTable);
    checkCallStatus(NullRustCallStatusErrorHandler(), status);
  });
...
final _PersisterFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_persister(ptr, status));
});
...
class Persister implements PersisterInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_persister(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_persister(_ptr, status));
  }
}
...
final _PolicyFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_policy(ptr, status));
});
...
class Policy implements PolicyInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_policy(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_policy(_ptr, status));
  }

  String asString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_policy_as_string(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  Satisfaction contribution() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_policy_contribution(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSatisfaction.lift,
      null,
    );
  }
  ...
  SatisfiableItem item() {
    return rustCallWithLifter(
      ...
      FfiConverterSatisfiableItem.lift,
      null,
    );
  }
  ...
  bool requiresPath() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_policy_requires_path(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  Satisfaction satisfaction() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_policy_satisfaction(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSatisfaction.lift,
...
class Psbt implements PsbtInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_psbt(_ptr, status));
  }
  ...
  FinalizedPsbtResult finalize() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_psbt_finalize(uniffiClonePointer(), status),
      FfiConverterFinalizedPsbtResult.lift,
      null,
    );
  }
  ...
  List<Input> input() {
    return rustCallWithLifter(
      ...
      FfiConverterSequenceInput.lift,
      null,
    );
  }
  ...
  String jsonSerialize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_psbt_json_serialize(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  List<Output> output() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_psbt_output(uniffiClonePointer(), status),
      FfiConverterSequenceOutput.lift,
      null,
    );
  }
  ...
  String serialize() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_psbt_serialize(uniffiClonePointer(), status),
      FfiConverterString.lift,
      null,
    );
  }
...
final _ScriptFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_script(ptr, status));
});
...
class Script implements ScriptInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_script(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_script(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_script_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  Uint8List toBytes() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_script_to_bytes(uniffiClonePointer(), status),
      FfiConverterUint8List.lift,
      null,
    );
  }
...
final _SyncRequestFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_syncrequest(ptr, status));
});
...
class SyncRequest implements SyncRequestInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_syncrequest(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_syncrequest(_ptr, status));
  }
}
...
final _SyncRequestBuilderFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_syncrequestbuilder(ptr, status));
});
...
class SyncRequestBuilder implements SyncRequestBuilderInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_syncrequestbuilder(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall(
      (status) => uniffi_bdkffi_fn_free_syncrequestbuilder(_ptr, status),
    );
  }

  SyncRequest build() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_syncrequestbuilder_build(
        uniffiClonePointer(),
        status,
      ),
      SyncRequest.lift,
  ...
  SyncRequestBuilder inspectSpks(SyncScriptInspector inspector) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_syncrequestbuilder_inspect_spks(
        uniffiClonePointer(),
        FfiConverterCallbackInterfaceSyncScriptInspector.lower(inspector),
        status,
      ),
      SyncRequestBuilder.lift,
      requestBuilderExceptionErrorHandler,
    );
  }
}
...
typedef UniffiCallbackInterfaceSyncScriptInspectorMethod0 =
    Void Function(
      Uint64,
      Pointer<Void>,
      Uint64,
...
typedef UniffiCallbackInterfaceSyncScriptInspectorMethod0Dart =
    void Function(
      int,
      Pointer<Void>,
      int,
...
typedef UniffiCallbackInterfaceSyncScriptInspectorClone =
    Uint64 Function(Uint64);
typedef UniffiCallbackInterfaceSyncScriptInspectorCloneDart = int Function(int);
...
final class UniffiVTableCallbackInterfaceSyncScriptInspector extends Struct {
  ...
  uniffiFree;
  external Pointer<
    NativeFunction<UniffiCallbackInterfaceSyncScriptInspectorClone>
  >
  uniffiClone;
  external Pointer<
...
void syncScriptInspectorInspect(
  int uniffiHandle,
  Pointer<Void> script,
  int total,
  Pointer<Void> outReturn,
  ...
  final status = callStatus.ref;
  try {
    final obj = FfiConverterCallbackInterfaceSyncScriptInspector._handleMap.get(
      uniffiHandle,
    );
    final arg0 = Script.lift(script);
    final arg1 = FfiConverterUInt64.lift(total);
    obj.inspect(arg0, arg1);
    status.code = CALL_SUCCESS;
  } catch (e) {
    status.code = CALL_UNEXPECTED_ERROR;
    status.errorBuf = FfiConverterString.lower(e.toString());
...
int syncScriptInspectorCloneCallback(int handle) {
  try {
    final obj = FfiConverterCallbackInterfaceSyncScriptInspector._handleMap.get(
      handle,
    );
    final newHandle = FfiConverterCallbackInterfaceSyncScriptInspector
        ._handleMap
        .insert(obj);
    return newHandle;
  } catch (e) {
...
final Pointer<NativeFunction<UniffiCallbackInterfaceSyncScriptInspectorClone>>
syncScriptInspectorClonePointer =
    Pointer.fromFunction<UniffiCallbackInterfaceSyncScriptInspectorClone>(
      syncScriptInspectorCloneCallback,
      0,
    );
...
void initSyncScriptInspectorVTable() {
  ...
  syncScriptInspectorVTable.ref.uniffiClone = syncScriptInspectorClonePointer;
...
abstract class TapTreeInterface {
  NodeInfo nodeInfo();
  String rootHash();
}

final _TapTreeFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_taptree(ptr, status));
});

class TapTree implements TapTreeInterface {
  late final Pointer<Void> _ptr;
  TapTree._(this._ptr) {
    _TapTreeFinalizer.attach(this, _ptr, detach: this);
  }
  factory TapTree.lift(Pointer<Void> ptr) {
    return TapTree._(ptr);
  }
  static Pointer<Void> lower(TapTree value) {
    return value.uniffiClonePointer();
  }

  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_taptree(_ptr, status));
  }
  ...
  static LiftRetVal<TapTree> read(Uint8List buf) {
    final handle = buf.buffer.asByteData(buf.offsetInBytes).getInt64(0);
    final pointer = Pointer<Void>.fromAddress(handle);
    return LiftRetVal(TapTree.lift(pointer), 8);
  }
  ...
  void dispose() {
    _TapTreeFinalizer.detach(this);
    rustCall((status) => uniffi_bdkffi_fn_free_taptree(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_taptree_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  NodeInfo nodeInfo() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_taptree_node_info(
        uniffiClonePointer(),
        status,
      ),
      NodeInfo.lift,
  ...
  String rootHash() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_taptree_root_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
...
class Transaction implements TransactionInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_transaction(_ptr, status),
    );
  }
  ...
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        Transaction.lower(other),
        status,
      ),
      FfiConverterBool.lift,
      null,
  ...
  Txid computeTxid() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_compute_txid(
        uniffiClonePointer(),
        status,
      ),
      Txid.lift,
  ...
  Wtxid computeWtxid() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_compute_wtxid(
        uniffiClonePointer(),
        status,
      ),
      Wtxid.lift,
  ...
  List<TxIn> input() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_input(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceTxIn.lift,
      null,
    );
  }
  ...
  bool isCoinbase() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_is_coinbase(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  bool isExplicitlyRbf() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_is_explicitly_rbf(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  bool isLockTimeEnabled() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_is_lock_time_enabled(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBool.lift,
  ...
  int lockTime() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_lock_time(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt32.lift,
  ...
  List<TxOut> output() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_output(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceTxOut.lift,
      null,
    );
  }
  ...
  Uint8List serialize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_serialize(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUint8List.lift,
  ...
  int totalSize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_total_size(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  int version() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_version(
        uniffiClonePointer(),
        status,
      ),
  ...
  int vsize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_vsize(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  int weight() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_transaction_weight(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
...
final _TxBuilderFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_txbuilder(ptr, status));
});
...
class TxBuilder implements TxBuilderInterface {
  ...
  TxBuilder()
    : _ptr = rustCall(
        (status) => uniffi_bdkffi_fn_constructor_txbuilder_new(status),
        null,
      ) {
    _TxBuilderFinalizer.attach(this, _ptr, detach: this);
  }
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_txbuilder(_ptr, status));
  }
  ...
  TxBuilder addGlobalXpubs() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_add_global_xpubs(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder addUtxos(List<OutPoint> outpoints) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_add_utxos(
        uniffiClonePointer(),
        FfiConverterSequenceOutPoint.lower(outpoints),
        status,
      ),
      TxBuilder.lift,
      null,
  ...
  TxBuilder doNotSpendChange() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_do_not_spend_change(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder drainWallet() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_drain_wallet(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder excludeUnconfirmed() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_exclude_unconfirmed(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder manuallySelectedOnly() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_manually_selected_only(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder onlySpendChange() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_only_spend_change(
        uniffiClonePointer(),
        status,
      ),
      TxBuilder.lift,
  ...
  TxBuilder unspendable(List<OutPoint> unspendable) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txbuilder_unspendable(
        uniffiClonePointer(),
        FfiConverterSequenceOutPoint.lower(unspendable),
        status,
      ),
      TxBuilder.lift,
      null,
...
final _TxMerkleNodeFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_txmerklenode(ptr, status));
});
...
class TxMerkleNode implements TxMerkleNodeInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall(
      (status) => uniffi_bdkffi_fn_clone_txmerklenode(_ptr, status),
    );
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_txmerklenode(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        TxMerkleNode.lower(other),
        status,
      ),
      FfiConverterBool.lift,
      null,
  ...
  int get hashCode {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  Uint8List serialize() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txmerklenode_serialize(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUint8List.lift,
...
final _TxidFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_txid(ptr, status));
});
...
class Txid implements TxidInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_txid(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_txid(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txid_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txid_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        Txid.lower(other),
        status,
      ),
  ...
  int get hashCode {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_txid_uniffi_trait_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  Uint8List serialize() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_txid_serialize(uniffiClonePointer(), status),
      FfiConverterUint8List.lift,
      null,
    );
  }
...
final _UpdateFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_update(ptr, status));
});
...
class Update implements UpdateInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_update(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_update(_ptr, status));
  }
}
...
class Wallet implements WalletInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_wallet(_ptr, status));
  }
  ...
  List<WalletEvent> applyUpdateEvents(Update update) {
    return rustCallWithLifter(
      ...
      FfiConverterSequenceWalletEvent.lift,
      cannotConnectExceptionErrorHandler,
    );
  }
  ...
  Balance balance() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_wallet_balance(uniffiClonePointer(), status),
  ...
  KeychainAndIndex? derivationOfSpk(Script spk) {
    return rustCallWithLifter(
      ...
      FfiConverterOptionalKeychainAndIndex.lift,
      null,
    );
  }
  ...
  CanonicalTx? getTx(Txid txid) {
    return rustCallWithLifter(
      ...
      FfiConverterOptionalCanonicalTx.lift,
      txidParseExceptionErrorHandler,
    );
  }
  ...
  LocalOutput? getUtxo(OutPoint op) {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_get_utxo(
        uniffiClonePointer(),
        FfiConverterOutPoint.lower(op),
        status,
      ),
      FfiConverterOptionalLocalOutput.lift,
      null,
    );
  }
  ...
  BlockId latestCheckpoint() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_latest_checkpoint(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterBlockId.lift,
      null,
    );
  }
  ...
  List<LocalOutput> listOutput() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_list_output(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceLocalOutput.lift,
      null,
    );
  }
  ...
  List<LocalOutput> listUnspent() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_list_unspent(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceLocalOutput.lift,
  ...
  List<AddressInfo> listUnusedAddresses(KeychainKind keychain) {
    return rustCallWithLifter(
      ...
      FfiConverterSequenceAddressInfo.lift,
      null,
    );
  }
  ...
  Network network() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_wallet_network(uniffiClonePointer(), status),
      FfiConverterNetwork.lift,
      null,
    );
  }
  ...
  Policy? policies(KeychainKind keychain) {
    return rustCallWithLifter(
      ...
      FfiConverterOptionalPolicy.lift,
      descriptorExceptionErrorHandler,
    );
  }
  ...
  SentAndReceivedValues sentAndReceived(Transaction tx) {
    return rustCallWithLifter(
      ...
      FfiConverterSentAndReceivedValues.lift,
      null,
    );
  }
  ...
  ChangeSet? staged() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_wallet_staged(uniffiClonePointer(), status),
      FfiConverterOptionalChangeSet.lift,
      null,
    );
  }
  ...
  FullScanRequestBuilder startFullScan() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_start_full_scan(
        uniffiClonePointer(),
        status,
      ),
      FullScanRequestBuilder.lift,
  ...
  ChangeSet? takeStaged() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_take_staged(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterOptionalChangeSet.lift,
  ...
  List<CanonicalTx> transactions() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wallet_transactions(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterSequenceCanonicalTx.lift,
      null,
    );
  }
  ...
  TxDetails? txDetails(Txid txid) {
    return rustCallWithLifter(
      ...
      FfiConverterOptionalTxDetails.lift,
      null,
    );
  }
...
final _WtxidFinalizer = Finalizer<Pointer<Void>>((ptr) {
  rustCall((status) => uniffi_bdkffi_fn_free_wtxid(ptr, status));
});
...
class Wtxid implements WtxidInterface {
  ...
  Pointer<Void> uniffiClonePointer() {
    return rustCall((status) => uniffi_bdkffi_fn_clone_wtxid(_ptr, status));
  }
  ...
  void dispose() {
    ...
    rustCall((status) => uniffi_bdkffi_fn_free_wtxid(_ptr, status));
  }

  @override
  String toString() {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wtxid_uniffi_trait_display(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterString.lift,
  ...
  bool operator ==(Object other) {
    ...
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wtxid_uniffi_trait_eq_eq(
        uniffiClonePointer(),
        Wtxid.lower(other),
        status,
      ),
  ...
  int get hashCode {
    return rustCallWithLifter(
      (status) => uniffi_bdkffi_fn_method_wtxid_uniffi_trait_hash(
        uniffiClonePointer(),
        status,
      ),
      FfiConverterUInt64.lift,
  ...
  Uint8List serialize() {
    return rustCallWithLifter(
      (status) =>
          uniffi_bdkffi_fn_method_wtxid_serialize(uniffiClonePointer(), status),
      FfiConverterUint8List.lift,
      null,
    );
  }
...
final class RustBuffer extends Struct {
  ...
  static RustBuffer alloc(int size) {
    return rustCall((status) => ffi_bdkffi_rustbuffer_alloc(size, status));
  }

  static RustBuffer fromBytes(ForeignBytes bytes) {
    return rustCall(
      (status) => ffi_bdkffi_rustbuffer_from_bytes(bytes, status),
    );
  }

  void free() {
    rustCall((status) => ffi_bdkffi_rustbuffer_free(this, status));
  }
...
class FfiConverterOptionalConfirmationBlockTime {
  static ConfirmationBlockTime? lift(RustBuffer buf) {
    return FfiConverterOptionalConfirmationBlockTime.read(
      buf.asUint8List(),
    ).value;
  }
  ...
  static LiftRetVal<ConfirmationBlockTime?> read(Uint8List buf) {
    ...
    final result = FfiConverterConfirmationBlockTime.read(
      Uint8List.view(buf.buffer, buf.offsetInBytes + 1),
    );
    return LiftRetVal<ConfirmationBlockTime?>(
      result.value,
      result.bytesRead + 1,
    );
  }
  ...
  static int allocationSize([ConfirmationBlockTime? value]) {
    ...
    return FfiConverterConfirmationBlockTime.allocationSize(value) + 1;
  }
  ...
  static RustBuffer lower(ConfirmationBlockTime? value) {
    ...
    final length = FfiConverterOptionalConfirmationBlockTime.allocationSize(
      value,
    );
    final Pointer<Uint8> frameData = calloc<Uint8>(length);
    final buf = frameData.asTypedList(length);
    FfiConverterOptionalConfirmationBlockTime.write(value, buf);
    final bytes = calloc<ForeignBytes>();
    bytes.ref.len = length;
    bytes.ref.data = frameData;
    return RustBuffer.fromBytes(bytes.ref);
  ...
  static int write(ConfirmationBlockTime? value, Uint8List buf) {
    ...
    buf[0] = 1;
    return FfiConverterConfirmationBlockTime.write(
          value,
          Uint8List.view(buf.buffer, buf.offsetInBytes + 1),
        ) +
        1;
...
class FfiConverterSequencePsbtFinalizeException {
  static List<PsbtFinalizeException> lift(RustBuffer buf) {
    return FfiConverterSequencePsbtFinalizeException.read(
      buf.asUint8List(),
    ).value;
  }
...
class FfiConverterSequenceCanonicalTx {
  ...
  static LiftRetVal<List<CanonicalTx>> read(Uint8List buf) {
    ...
    int offset = buf.offsetInBytes + 4;
    for (var i = 0; i < length; i++) {
      final ret = FfiConverterCanonicalTx.read(
        Uint8List.view(buf.buffer, offset),
      );
      offset += ret.bytesRead;
      res.add(ret.value);
...
class FfiConverterMapProprietaryKeyToUint8List {
  static Map<ProprietaryKey, Uint8List> lift(RustBuffer buf) {
    return FfiConverterMapProprietaryKeyToUint8List.read(
      buf.asUint8List(),
    ).value;
  }
  ...
  static LiftRetVal<Map<ProprietaryKey, Uint8List>> read(Uint8List buf) {
    ...
    int offset = buf.offsetInBytes + 4;
    for (var i = 0; i < length; i++) {
      final k = FfiConverterProprietaryKey.read(
        Uint8List.view(buf.buffer, offset),
      );
      offset += k.bytesRead;
      final v = FfiConverterUint8List.read(Uint8List.view(buf.buffer, offset));
...
const _uniffiAssetId = "package:bdk_dart/uniffi:bdk_dart_ffi";
@Native<Pointer<Void> Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_clone_address(
  Pointer<Void> handle,
...
external void uniffi_bdkffi_fn_free_address(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_address_from_script(
  Pointer<Void> script,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_address_new(
  RustBuffer address,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_address_is_valid_for_network(
  Pointer<Void> ptr,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_address_script_pubkey(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_address_to_address_data(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_address_to_qr_uri(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_address_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_address_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_address_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_amount(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_amount(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Pointer<Void> Function(Double, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_constructor_amount_from_btc(
  double btc,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_amount_from_sat(
  int satoshi,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external double uniffi_bdkffi_fn_method_amount_to_btc(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_amount_to_sat(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_blockhash(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_blockhash(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_blockhash_from_bytes(
  RustBuffer bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_blockhash_from_string(
  RustBuffer hex,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_blockhash_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_blockhash_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_blockhash_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_blockhash_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_blockhash_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_blockhash_uniffi_trait_ord_cmp(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_bumpfeetxbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_bumpfeetxbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_bumpfeetxbuilder_new(
  Pointer<Void> txid,
  Pointer<Void> fee_rate,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Pointer<Void> Function(Pointer<Void>, Int8, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_method_bumpfeetxbuilder_allow_dust(
  Pointer<Void> ptr,
  int allow_dust,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_bumpfeetxbuilder_current_height(
  Pointer<Void> ptr,
  int height,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_bumpfeetxbuilder_finish(
  Pointer<Void> ptr,
  Pointer<Void> wallet,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_bumpfeetxbuilder_nlocktime(
  Pointer<Void> ptr,
  RustBuffer locktime,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<Pointer<Void> Function(Pointer<Void>, Int32, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_method_bumpfeetxbuilder_version(
  Pointer<Void> ptr,
  int version,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_cbfbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_cbfbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_cbfbuilder_new(
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_cbfbuilder_build(
  Pointer<Void> ptr,
  Pointer<Void> wallet,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Uint64, Uint64, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void>
...
@Native<Pointer<Void> Function(Pointer<Void>, Uint8, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfbuilder_connections(
  Pointer<Void> ptr,
  int connections,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfbuilder_data_dir(
  Pointer<Void> ptr,
  RustBuffer data_dir,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfbuilder_peers(
  Pointer<Void> ptr,
  RustBuffer peers,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfbuilder_scan_type(
  Pointer<Void> ptr,
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfbuilder_socks5_proxy(
  Pointer<Void> ptr,
  RustBuffer proxy,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_cbfclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_cbfclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_average_fee_rate(
  Pointer<Void> ptr,
...
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_broadcast(
  Pointer<Void> ptr,
  Pointer<Void> transaction,
);

@Native<Void Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external void uniffi_bdkffi_fn_method_cbfclient_connect(
  Pointer<Void> ptr,
  RustBuffer peer,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_cbfclient_is_running(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_cbfclient_lookup_host(
  Pointer<Void> ptr,
  RustBuffer hostname,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_min_broadcast_feerate(
  Pointer<Void> ptr,
);

@Native<Pointer<Void> Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_next_info(
  Pointer<Void> ptr,
);

@Native<Pointer<Void> Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_next_warning(
  Pointer<Void> ptr,
);
...
external void uniffi_bdkffi_fn_method_cbfclient_shutdown(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Pointer<Void> Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_cbfclient_update(
  Pointer<Void> ptr,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_cbfnode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_cbfnode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_cbfnode_run(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_changeset(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_changeset(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_changeset_from_aggregate(
  RustBuffer descriptor,
  RustBuffer change_descriptor,
  RustBuffer network,
  RustBuffer local_chain,
  RustBuffer tx_graph,
  RustBuffer indexer,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void>
uniffi_bdkffi_fn_constructor_changeset_from_local_chain_changes(
  RustBuffer local_chain_changes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_changeset_from_merge(
  Pointer<Void> left,
  Pointer<Void> right,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_changeset_new(
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_change_descriptor(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_descriptor(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_indexer_changeset(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_localchain_changeset(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_network(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_changeset_tx_graph_changeset(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_derivationpath(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_derivationpath(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_derivationpath_master(
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_derivationpath_new(
  RustBuffer path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_derivationpath_is_empty(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_derivationpath_is_master(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_derivationpath_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_descriptor(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_descriptor(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(RustBuffer, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new(
  RustBuffer descriptor,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip44(
  Pointer<Void> secret_key,
  RustBuffer keychain_kind,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip44_public(
  Pointer<Void> public_key,
  RustBuffer fingerprint,
  RustBuffer keychain_kind,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip49(
  Pointer<Void> secret_key,
  RustBuffer keychain_kind,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip49_public(
  Pointer<Void> public_key,
  RustBuffer fingerprint,
  RustBuffer keychain_kind,
  RustBuffer network,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip84(
  Pointer<Void> secret_key,
  RustBuffer keychain_kind,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip84_public(
  Pointer<Void> public_key,
  RustBuffer fingerprint,
  RustBuffer keychain_kind,
  RustBuffer network,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip86(
  Pointer<Void> secret_key,
  RustBuffer keychain_kind,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptor_new_bip86_public(
  Pointer<Void> public_key,
  RustBuffer fingerprint,
  RustBuffer keychain_kind,
  RustBuffer network,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_descriptor_derive_address(
  Pointer<Void> ptr,
  int index,
  RustBuffer network,
  Pointer<RustCallStatus> uniffiStatus,
...
external RustBuffer uniffi_bdkffi_fn_method_descriptor_desc_type(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_descriptor_descriptor_id(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptor_is_multipath(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptor_max_weight_to_satisfy(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptor_to_single_descriptors(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptor_to_string_with_secret(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptor_uniffi_trait_debug(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptor_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_descriptorid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_descriptorid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptorid_from_bytes(
  RustBuffer bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptorid_from_string(
  RustBuffer hex,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptorid_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptorid_uniffi_trait_ord_cmp(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_descriptorpublickey(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_descriptorpublickey(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_descriptorpublickey_derive(
  Pointer<Void> ptr,
  Pointer<Void> path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_descriptorpublickey_extend(
  Pointer<Void> ptr,
  Pointer<Void> path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_descriptorpublickey_is_multipath(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_descriptorsecretkey(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_descriptorsecretkey(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_descriptorsecretkey_new(
  RustBuffer network,
...
external Pointer<Void> uniffi_bdkffi_fn_method_descriptorsecretkey_as_public(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_descriptorsecretkey_derive(
  Pointer<Void> ptr,
  Pointer<Void> path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_descriptorsecretkey_extend(
  Pointer<Void> ptr,
  Pointer<Void> path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_descriptorsecretkey_secret_bytes(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_electrumclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_electrumclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(RustBuffer, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_electrumclient_new(
  RustBuffer url,
  RustBuffer socks5,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<Double Function(Pointer<Void>, Uint64, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_electrumclient_full_scan(
  Pointer<Void> ptr,
  Pointer<Void> request,
  int stop_gap,
  int batch_size,
  int fetch_prev_txouts,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_electrumclient_server_features(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_electrumclient_sync(
  Pointer<Void> ptr,
  Pointer<Void> request,
  int batch_size,
  int fetch_prev_txouts,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_esploraclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_esploraclient(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(RustBuffer, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_esploraclient_new(
  RustBuffer url,
  RustBuffer proxy,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_esploraclient_broadcast(
  Pointer<Void> ptr,
  Pointer<Void> transaction,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_esploraclient_full_scan(
  Pointer<Void> ptr,
  Pointer<Void> request,
  int stop_gap,
...
external Pointer<Void> uniffi_bdkffi_fn_method_esploraclient_get_block_hash(
  Pointer<Void> ptr,
  int block_height,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_esploraclient_get_fee_estimates(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_esploraclient_get_tx(
  Pointer<Void> ptr,
  Pointer<Void> txid,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_esploraclient_get_tx_info(
  Pointer<Void> ptr,
  Pointer<Void> txid,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_esploraclient_sync(
  Pointer<Void> ptr,
  Pointer<Void> request,
  int parallel_requests,
  Pointer<RustCallStatus> uniffiStatus,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_feerate(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_feerate(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_feerate_from_sat_per_kwu(
  int sat_kwu,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_feerate_from_sat_per_vb(
  int sat_vb,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_feerate_fee_vb(
  Pointer<Void> ptr,
  int vb,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_feerate_fee_wu(
  Pointer<Void> ptr,
  int wu,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_feerate_to_sat_per_kwu(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_feerate_to_sat_per_vb_ceil(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_feerate_to_sat_per_vb_floor(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_feerate_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_fullscanrequest(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_fullscanrequest(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_fullscanrequestbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_fullscanrequestbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_fullscanrequestbuilder_build(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_fullscanscriptinspector(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_fullscanscriptinspector(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<
  Void Function(Pointer<UniffiVTableCallbackInterfaceFullScanScriptInspector>)
>(assetId: _uniffiAssetId)
external void uniffi_bdkffi_fn_init_callback_vtable_fullscanscriptinspector(
  Pointer<UniffiVTableCallbackInterfaceFullScanScriptInspector> vtable,
);
...
>(assetId: _uniffiAssetId)
external void uniffi_bdkffi_fn_method_fullscanscriptinspector_inspect(
  Pointer<Void> ptr,
  RustBuffer keychain,
  int index,
  Pointer<Void> script,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_hashableoutpoint(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_hashableoutpoint(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_hashableoutpoint_new(
  RustBuffer outpoint,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_hashableoutpoint_outpoint(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_hashableoutpoint_uniffi_trait_debug(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_hashableoutpoint_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_hashableoutpoint_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_hashableoutpoint_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_ipaddress(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_ipaddress(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<
  Pointer<Void> Function(Uint8, Uint8, Uint8, Uint8, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_ipaddress_from_ipv4(
  int q1,
  int q2,
  int q3,
  int q4,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_ipaddress_from_ipv6(
  int a,
  int b,
  int c,
  int d,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_leafnode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_leafnode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_leafnode_depth(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_leaf_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_leaf_version(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_merkle_branch(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_node_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_script(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_leafnode_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_mnemonic(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_mnemonic(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_mnemonic_from_entropy(
  RustBuffer entropy,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_mnemonic_from_string(
  RustBuffer mnemonic,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_mnemonic_new(
...
external RustBuffer uniffi_bdkffi_fn_method_mnemonic_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_nodeinfo(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_nodeinfo(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_nodeinfo_leaf_nodes(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_nodeinfo_node_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_nodeinfo_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_persistence(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_persistence(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Void Function(Pointer<UniffiVTableCallbackInterfacePersistence>)>(
  assetId: _uniffiAssetId,
)
external void uniffi_bdkffi_fn_init_callback_vtable_persistence(
  Pointer<UniffiVTableCallbackInterfacePersistence> vtable,
);

@Native<Pointer<Void> Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external Pointer<Void> uniffi_bdkffi_fn_method_persistence_initialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_persistence_persist(
  Pointer<Void> ptr,
  Pointer<Void> changeset,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_persister(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_persister(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_persister_custom(
  Pointer<Void> persistence,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_persister_new_in_memory(
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_persister_new_sqlite(
  RustBuffer path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_policy(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_policy(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_policy_as_string(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_policy_contribution(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_policy_id(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_policy_item(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_policy_requires_path(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_policy_satisfaction(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_psbt(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_psbt(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_psbt_from_file(
  RustBuffer path,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_psbt_from_unsigned_tx(
  Pointer<Void> tx,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_psbt_new(
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_psbt_combine(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_psbt_extract_tx(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_psbt_fee(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_finalize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_input(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_json_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_output(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_psbt_spend_utxo(
  Pointer<Void> ptr,
  int input_index,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_script(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_script(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_script_new(
  RustBuffer raw_output_script,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_script_to_bytes(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_script_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_syncrequest(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_syncrequest(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_syncrequestbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_syncrequestbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_syncrequestbuilder_build(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_syncrequestbuilder_inspect_spks(
  Pointer<Void> ptr,
  Pointer<Void> inspector,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_syncscriptinspector(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_syncscriptinspector(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<
  Void Function(Pointer<UniffiVTableCallbackInterfaceSyncScriptInspector>)
>(assetId: _uniffiAssetId)
external void uniffi_bdkffi_fn_init_callback_vtable_syncscriptinspector(
  Pointer<UniffiVTableCallbackInterfaceSyncScriptInspector> vtable,
);

@Native<
  Void Function(Pointer<Void>, Pointer<Void>, Uint64, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external void uniffi_bdkffi_fn_method_syncscriptinspector_inspect(
  Pointer<Void> ptr,
  Pointer<Void> script,
  int total,
  Pointer<RustCallStatus> uniffiStatus,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_taptree(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_taptree(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_taptree_node_info(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_taptree_root_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_taptree_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_transaction(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_transaction(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_transaction_new(
  RustBuffer transaction_bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_transaction_compute_txid(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_transaction_compute_wtxid(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_transaction_input(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_is_coinbase(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_is_explicitly_rbf(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_is_lock_time_enabled(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_lock_time(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_transaction_output(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_transaction_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_total_size(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_version(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_vsize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_weight(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_transaction_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_transaction_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_txbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_txbuilder(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_txbuilder_new(
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_data(
  Pointer<Void> ptr,
  RustBuffer data,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_global_xpubs(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_recipient(
  Pointer<Void> ptr,
  Pointer<Void> script,
  Pointer<Void> amount,
  Pointer<RustCallStatus> uniffiStatus,
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_unspendable(
  Pointer<Void> ptr,
  RustBuffer unspendable,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_utxo(
  Pointer<Void> ptr,
  RustBuffer outpoint,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_add_utxos(
  Pointer<Void> ptr,
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_allow_dust(
  Pointer<Void> ptr,
  int allow_dust,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_current_height(
  Pointer<Void> ptr,
  int height,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_do_not_spend_change(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_drain_to(
  Pointer<Void> ptr,
  Pointer<Void> script,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_drain_wallet(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_exclude_unconfirmed(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_fee_absolute(
  Pointer<Void> ptr,
  Pointer<Void> fee_amount,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_fee_rate(
  Pointer<Void> ptr,
  Pointer<Void> fee_rate,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_finish(
  Pointer<Void> ptr,
  Pointer<Void> wallet,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_manually_selected_only(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_nlocktime(
  Pointer<Void> ptr,
  RustBuffer locktime,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_policy_path(
  Pointer<Void> ptr,
  RustBuffer policy_path,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_set_exact_sequence(
  Pointer<Void> ptr,
  int nsequence,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_set_recipients(
  Pointer<Void> ptr,
...
@Native<
  Pointer<Void> Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_unspendable(
  Pointer<Void> ptr,
  RustBuffer unspendable,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_txbuilder_version(
  Pointer<Void> ptr,
  int version,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_txmerklenode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_txmerklenode(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_txmerklenode_from_bytes(
  RustBuffer bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_txmerklenode_from_string(
  RustBuffer hex,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_txmerklenode_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txmerklenode_uniffi_trait_ord_cmp(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_txid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_txid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_txid_from_bytes(
  RustBuffer bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_txid_from_string(
  RustBuffer hex,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_txid_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_txid_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txid_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txid_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txid_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_txid_uniffi_trait_ord_cmp(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_update(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_update(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_clone_wallet(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_wallet(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_wallet_create_single(
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_wallet_load(
  Pointer<Void> descriptor,
...
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_constructor_wallet_new(
  Pointer<Void> descriptor,
  Pointer<Void> change_descriptor,
  RustBuffer network,
  Pointer<Void> persister,
...
external void uniffi_bdkffi_fn_method_wallet_apply_evicted_txs(
  Pointer<Void> ptr,
  RustBuffer evicted_txs,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_wallet_apply_unconfirmed_txs(
  Pointer<Void> ptr,
  RustBuffer unconfirmed_txs,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_wallet_apply_update(
  Pointer<Void> ptr,
  Pointer<Void> update,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_apply_update_events(
  Pointer<Void> ptr,
  Pointer<Void> update,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_balance(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_wallet_calculate_fee(
  Pointer<Void> ptr,
  Pointer<Void> tx,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external Pointer<Void> uniffi_bdkffi_fn_method_wallet_calculate_fee_rate(
  Pointer<Void> ptr,
  Pointer<Void> tx,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_method_wallet_cancel_tx(
  Pointer<Void> ptr,
  Pointer<Void> tx,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_derivation_index(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_derivation_of_spk(
  Pointer<Void> ptr,
  Pointer<Void> spk,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_descriptor_checksum(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_fn_method_wallet_finalize_psbt(
  Pointer<Void> ptr,
  Pointer<Void> psbt,
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_get_tx(
  Pointer<Void> ptr,
  Pointer<Void> txid,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_get_utxo(
  Pointer<Void> ptr,
  RustBuffer op,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void uniffi_bdkffi_fn_method_wallet_insert_txout(
  Pointer<Void> ptr,
  RustBuffer outpoint,
  RustBuffer txout,
  Pointer<RustCallStatus> uniffiStatus,
...
external int uniffi_bdkffi_fn_method_wallet_is_mine(
  Pointer<Void> ptr,
  Pointer<Void> script,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_latest_checkpoint(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_list_output(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_list_unspent(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_list_unused_addresses(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Int8 Function(Pointer<Void>, RustBuffer, Uint32, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_fn_method_wallet_mark_used(
  Pointer<Void> ptr,
  RustBuffer keychain,
  int index,
  Pointer<RustCallStatus> uniffiStatus,
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_network(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Uint32 Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int uniffi_bdkffi_fn_method_wallet_next_derivation_index(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_next_unused_address(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_peek_address(
  Pointer<Void> ptr,
  RustBuffer keychain,
  int index,
  Pointer<RustCallStatus> uniffiStatus,
...
external int uniffi_bdkffi_fn_method_wallet_persist(
  Pointer<Void> ptr,
  Pointer<Void> persister,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_policies(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_public_descriptor(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_reveal_addresses_to(
  Pointer<Void> ptr,
  RustBuffer keychain,
  int index,
  Pointer<RustCallStatus> uniffiStatus,
...
@Native<
  RustBuffer Function(Pointer<Void>, RustBuffer, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_reveal_next_address(
  Pointer<Void> ptr,
  RustBuffer keychain,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_sent_and_received(
  Pointer<Void> ptr,
  Pointer<Void> tx,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_fn_method_wallet_sign(
  Pointer<Void> ptr,
  Pointer<Void> psbt,
  RustBuffer sign_options,
  Pointer<RustCallStatus> uniffiStatus,
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_staged(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_method_wallet_start_full_scan(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_take_staged(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wallet_transactions(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  RustBuffer Function(Pointer<Void>, Pointer<Void>, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external RustBuffer uniffi_bdkffi_fn_method_wallet_tx_details(
  Pointer<Void> ptr,
  Pointer<Void> txid,
  Pointer<RustCallStatus> uniffiStatus,
);
...
@Native<
  Int8 Function(Pointer<Void>, RustBuffer, Uint32, Pointer<RustCallStatus>)
>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_fn_method_wallet_unmark_used(
  Pointer<Void> ptr,
  RustBuffer keychain,
  int index,
  Pointer<RustCallStatus> uniffiStatus,
...
external Pointer<Void> uniffi_bdkffi_fn_clone_wtxid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void uniffi_bdkffi_fn_free_wtxid(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_wtxid_from_bytes(
  RustBuffer bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external Pointer<Void> uniffi_bdkffi_fn_constructor_wtxid_from_string(
  RustBuffer hex,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wtxid_serialize(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_wtxid_uniffi_trait_display(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_wtxid_uniffi_trait_eq_eq(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_wtxid_uniffi_trait_eq_ne(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_wtxid_uniffi_trait_hash(
  Pointer<Void> ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external int uniffi_bdkffi_fn_method_wtxid_uniffi_trait_ord_cmp(
  Pointer<Void> ptr,
  Pointer<Void> other,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_walletevent_uniffi_trait_display(
  RustBuffer ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer uniffi_bdkffi_fn_method_conflict_uniffi_trait_display(
  RustBuffer ptr,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer ffi_bdkffi_rustbuffer_alloc(
  int size,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer ffi_bdkffi_rustbuffer_from_bytes(
  ForeignBytes bytes,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external void ffi_bdkffi_rustbuffer_free(
  RustBuffer buf,
  Pointer<RustCallStatus> uniffiStatus,
);
...
external RustBuffer ffi_bdkffi_rustbuffer_reserve(
  RustBuffer buf,
  int additional,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_u8(
  Pointer<Void> handle,
...
external void ffi_bdkffi_rust_future_cancel_u8(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_u8(Pointer<Void> handle);

@Native<Uint8 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_u8(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_i8(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_i8(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_i8(Pointer<Void> handle);

@Native<Int8 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_i8(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_u16(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_u16(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_u16(Pointer<Void> handle);

@Native<Uint16 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_u16(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_i16(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_i16(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_i16(Pointer<Void> handle);

@Native<Int16 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_i16(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_u32(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_u32(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_u32(Pointer<Void> handle);

@Native<Uint32 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_u32(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_i32(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_i32(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_i32(Pointer<Void> handle);

@Native<Int32 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_i32(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_u64(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_u64(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_u64(Pointer<Void> handle);

@Native<Uint64 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_u64(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_i64(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_i64(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_i64(Pointer<Void> handle);

@Native<Int64 Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external int ffi_bdkffi_rust_future_complete_i64(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_f32(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_f32(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_f32(Pointer<Void> handle);

@Native<Float Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external double ffi_bdkffi_rust_future_complete_f32(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_f64(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_f64(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_f64(Pointer<Void> handle);

@Native<Double Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external double ffi_bdkffi_rust_future_complete_f64(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_rust_buffer(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_rust_buffer(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_rust_buffer(Pointer<Void> handle);

@Native<RustBuffer Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external RustBuffer ffi_bdkffi_rust_future_complete_rust_buffer(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);
...
>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_poll_void(
  Pointer<Void> handle,
  Pointer<NativeFunction<UniffiRustFutureContinuationCallback>> callback,
  Pointer<Void> callback_data,
);
...
@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_cancel_void(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>)>(assetId: _uniffiAssetId)
external void ffi_bdkffi_rust_future_free_void(Pointer<Void> handle);

@Native<Void Function(Pointer<Void>, Pointer<RustCallStatus>)>(
  assetId: _uniffiAssetId,
)
external void ffi_bdkffi_rust_future_complete_void(
  Pointer<Void> handle,
  Pointer<RustCallStatus> uniffiStatus,
);

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_address_is_valid_for_network();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_address_script_pubkey();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_address_to_address_data();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_address_to_qr_uri();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_amount_to_btc();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_amount_to_sat();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_blockhash_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_bumpfeetxbuilder_allow_dust();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_bumpfeetxbuilder_current_height();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_bumpfeetxbuilder_finish();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_bumpfeetxbuilder_nlocktime();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_bumpfeetxbuilder_version();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfbuilder_build();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfbuilder_connections();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfbuilder_scan_type();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfbuilder_socks5_proxy();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_average_fee_rate();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_broadcast();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_connect();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_is_running();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_lookup_host();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_min_broadcast_feerate();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_next_info();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_next_warning();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_shutdown();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfclient_update();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_cbfnode_run();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_changeset_change_descriptor();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_changeset_descriptor();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_changeset_indexer_changeset();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_changeset_localchain_changeset();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_changeset_network();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_derivationpath_is_master();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_desc_type();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_descriptor_id();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_is_multipath();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_max_weight_to_satisfy();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_to_single_descriptors();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptor_to_string_with_secret();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorid_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorpublickey_derive();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorpublickey_extend();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorpublickey_is_multipath();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorsecretkey_as_public();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorsecretkey_derive();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_descriptorsecretkey_extend();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_electrumclient_sync();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_feerate_fee_vb();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_feerate_fee_wu();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_feerate_to_sat_per_kwu();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_feerate_to_sat_per_vb_ceil();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_feerate_to_sat_per_vb_floor();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_fullscanrequestbuilder_build();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_fullscanscriptinspector_inspect();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_hashableoutpoint_outpoint();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_depth();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_leaf_hash();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_leaf_version();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_merkle_branch();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_node_hash();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_leafnode_script();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_nodeinfo_leaf_nodes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_nodeinfo_node_hash();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_persistence_initialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_persistence_persist();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_as_string();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_contribution();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_id();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_item();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_requires_path();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_policy_satisfaction();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_combine();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_finalize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_input();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_json_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_output();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_spend_utxo();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_psbt_write_to_file();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_script_to_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_syncrequestbuilder_build();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_syncrequestbuilder_inspect_spks();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_syncscriptinspector_inspect();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_taptree_node_info();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_taptree_root_hash();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_compute_txid();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_compute_wtxid();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_input();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_is_coinbase();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_is_explicitly_rbf();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_is_lock_time_enabled();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_lock_time();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_output();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_total_size();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_version();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_vsize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_transaction_weight();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_add_recipient();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_add_unspendable();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_add_utxo();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_add_utxos();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_allow_dust();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_do_not_spend_change();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_drain_to();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_drain_wallet();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_exclude_unconfirmed();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_fee_absolute();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_fee_rate();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_finish();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_manually_selected_only();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_nlocktime();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_set_exact_sequence();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_set_recipients();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_unspendable();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txbuilder_version();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txmerklenode_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_txid_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_apply_evicted_txs();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_apply_unconfirmed_txs();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_apply_update();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_apply_update_events();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_balance();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_calculate_fee();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_calculate_fee_rate();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_cancel_tx();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_derivation_index();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_derivation_of_spk();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_descriptor_checksum();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_finalize_psbt();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_get_tx();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_get_utxo();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_insert_txout();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_is_mine();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_latest_checkpoint();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_list_output();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_list_unspent();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_list_unused_addresses();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_mark_used();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_network();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_next_derivation_index();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_next_unused_address();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_peek_address();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_persist();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_policies();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_public_descriptor();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_reveal_addresses_to();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_reveal_next_address();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_sent_and_received();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_start_full_scan();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_take_staged();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_transactions();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_tx_details();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wallet_unmark_used();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_method_wtxid_serialize();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_address_from_script();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_address_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_amount_from_btc();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_amount_from_sat();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_blockhash_from_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_blockhash_from_string();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_bumpfeetxbuilder_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_cbfbuilder_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_changeset_from_aggregate();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_changeset_from_merge();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_changeset_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_derivationpath_master();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_derivationpath_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip44();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip44_public();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip49();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip49_public();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip84();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip84_public();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip86();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptor_new_bip86_public();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptorid_from_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptorid_from_string();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_descriptorsecretkey_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_electrumclient_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_esploraclient_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_feerate_from_sat_per_kwu();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_feerate_from_sat_per_vb();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_hashableoutpoint_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_ipaddress_from_ipv4();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_ipaddress_from_ipv6();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_mnemonic_from_entropy();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_mnemonic_from_string();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_mnemonic_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_persister_custom();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_persister_new_in_memory();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_persister_new_sqlite();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_psbt_from_file();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_psbt_from_unsigned_tx();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_psbt_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_script_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_transaction_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_txbuilder_new();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_txmerklenode_from_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_txmerklenode_from_string();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_txid_from_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_txid_from_string();
...
@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_wtxid_from_bytes();

@Native<Uint16 Function()>(assetId: _uniffiAssetId)
external int uniffi_bdkffi_checksum_constructor_wtxid_from_string();

@Native<Uint32 Function()>(assetId: _uniffiAssetId)
external int ffi_bdkffi_uniffi_contract_version();

void _checkApiVersion() {
  final bindingsVersion = 30;
  final scaffoldingVersion = ffi_bdkffi_uniffi_contract_version();
...
void _checkApiChecksums() {
  ...
  if (uniffi_bdkffi_checksum_method_bumpfeetxbuilder_current_height() !=
      25489) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_bumpfeetxbuilder_set_exact_sequence() !=
      13533) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_cbfbuilder_configure_timeout_millis() !=
      41120) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_cbfclient_min_broadcast_feerate() !=
      31908) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_descriptor_max_weight_to_satisfy() !=
      27840) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_method_descriptor_to_single_descriptors() !=
      24048) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_method_descriptor_to_string_with_secret() !=
      44538) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_descriptorpublickey_is_multipath() !=
      23614) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_method_descriptorpublickey_master_fingerprint() !=
      43604) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_electrumclient_transaction_broadcast() !=
      24746) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_esploraclient_get_fee_estimates() !=
      62859) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_fullscanrequestbuilder_inspect_spks_for_all_keychains() !=
      43667) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_method_fullscanscriptinspector_inspect() !=
      36414) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_syncrequestbuilder_inspect_spks() !=
      38063) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_transaction_is_lock_time_enabled() !=
      17927) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_txbuilder_add_foreign_utxo() != 18425) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_txbuilder_exclude_below_confirmations() !=
      24447) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_txbuilder_manually_selected_only() !=
      17632) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_txbuilder_only_witness_utxo() != 43626) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_method_wallet_start_sync_with_revealed_spks() !=
      37305) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_changeset_from_descriptor_and_network() !=
      39614) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_constructor_changeset_from_indexer_changeset() !=
      52453) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_constructor_changeset_from_local_chain_changes() !=
      14452) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_changeset_from_tx_graph_changeset() !=
      31574) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip44_public() !=
      44307) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip49_public() !=
      5708) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_descriptor_new_bip86_public() !=
      18734) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  ...
  if (uniffi_bdkffi_checksum_constructor_descriptorpublickey_from_string() !=
      45545) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
  if (uniffi_bdkffi_checksum_constructor_descriptorsecretkey_from_string() !=
      11133) {
    throw UniffiInternalError.panicked("UniFFI API checksum mismatch");
  }
